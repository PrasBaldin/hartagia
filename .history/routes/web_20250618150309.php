...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    ...
    // edit services
    Route::get('/services/{id}/edit', 'ServiceController@edit')->name('admin.services.edit');
    Route::post('/services/{id}/update', 'ServiceController@update')->name('admin.services.update');
    // delete services
    Route::delete('/services/delete/{id}', 'ServiceController@delete')->name('admin.services.delete');
