...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    ...
    // delete portfolio
    Route::get('/portfolio/{id}/delete', 'PortfolioController@delete')->name('admin.portfolio.delete');


    // Route::delete('/portfolio/{id}/delete', 'PortfolioController@delete')->name('admin.portfolio.delete');
