...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('/portfolio/{id}/update', 'PortfolioController@update')->name('admin.portfolio.update');
    // delete portfolio
    ...
    Route::post('/services/store', 'ServiceController@store')->name('admin.service.store');
    // edit services
    Route::get('/services/{id}/edit', 'ServiceController@edit')->name('admin.service.edit');
    Route::post('/services/{id}/update', 'ServiceController@update')->name('admin.service.update');
    // delete services
    Route::delete('/services/delete/{id}', 'ServiceController@delete')->name('admin.service.delete');
