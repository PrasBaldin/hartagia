...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Translation::insert([
                ['table_name' => 'services', 'column_name' => 'service_name', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_name_id, 'created_at' => now()],
                ['table_name' => 'services', 'column_name' => 'service_name', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_name_en, 'created_at' => now()],
                ['table_name' => 'services', 'column_name' => 'service_desc', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_desc_id, 'created_at' => now()],
                ['table_name' => 'services', 'column_name' => 'service_desc', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_desc_en, 'created_at' => now()],
                ['table_name' => 'services', 'column_name' => 'service_content', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_content_id, 'created_at' => now()],
                ['table_name' => 'services', 'column_name' => 'service_content', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_content_en, 'created_at' => now()]
            ]);
