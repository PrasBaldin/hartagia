...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Translation::insert([
                ['table_name' => 'portfolios', 'column_name' => 'project_name', 'row_id' => $portfolio->id, 'language' => 'id', 'translated_text' => $request->project_name_id, 'created_at' => now()],
                ['table_name' => 'portfolios', 'column_name' => 'project_name', 'row_id' => $portfolio->id, 'language' => 'en', 'translated_text' => $request->project_name_en, 'created_at' => now()],
                ['table_name' => 'portfolios', 'column_name' => 'project_desc', 'row_id' => $portfolio->id, 'language' => 'id', 'translated_text' => $request->project_desc_id, 'created_at' => now()],
                ['table_name' => 'portfolios', 'column_name' => 'project_desc', 'row_id' => $portfolio->id, 'language' => 'en', 'translated_text' => $request->project_desc_en, 'created_at' => now()],
                ['table_name' => 'portfolios', 'column_name' => 'project_content', 'row_id' => $portfolio->id, 'language' => 'id', 'translated_text' => $request->project_content_id, 'created_at' => now()],
                ['table_name' => 'portfolios', 'column_name' => 'project_content', 'row_id' => $portfolio->id, 'language' => 'en', 'translated_text' => $request->project_content_en, 'created_at' => now()]
            ]);
