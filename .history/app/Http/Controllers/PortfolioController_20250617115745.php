...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Translation::insert([
            ...
            ['table_name' => 'portfolios', 'column_name' => 'content', 'row_id' => $portfolio->id, 'language' => 'id', 'translated_text' => $request->content_id],
            ['table_name' => 'portfolios', 'column_name' => 'content', 'row_id' => $portfolio->id, 'language' => 'en', 'translated_text' => $request->content_en]
        ]);
