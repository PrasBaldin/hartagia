...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'service_point_1_id' => 'nullable|string',
            'service_point_1_en' => 'nullable|string',
            'service_point_2_id' => 'nullable|string',
            'service_point_2_en' => 'nullable|string',
            'service_point_3_id' => 'nullable|string',
            'service_point_3_en' => 'nullable|string',
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                $filename = time() . '_' . Str::random(12) . '.' . $request->file('image')->getClientOriginalExtension();
                $destination = public_path('images\service_images');
                ...
                $imagePath = 'images/service_images/' . $filename;
            }
            ...
            Translation::insert([
                ...
                ['table_name' => 'services', 'column_name' => 'service_point_1', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_point_1_id, 'created_at' => Carbon::now()],
                ['table_name' => 'services', 'column_name' => 'service_point_1', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_point_1_en, 'created_at' => Carbon::now()],
                ['table_name' => 'services', 'column_name' => 'service_point_2', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_point_2_id, 'created_at' => Carbon::now()],
                ['table_name' => 'services', 'column_name' => 'service_point_2', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_point_2_en, 'created_at' => Carbon::now()],
                ['table_name' => 'services', 'column_name' => 'service_point_3', 'row_id' => $service->id, 'language' => 'id', 'translated_text' => $request->service_point_3_id, 'created_at' => Carbon::now()],
                ['table_name' => 'services', 'column_name' => 'service_point_3', 'row_id' => $service->id, 'language' => 'en', 'translated_text' => $request->service_point_3_en, 'created_at' => Carbon::now()],
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                if ($imagePath) {
                    ...
                    $oldPath = public_path(basename($imagePath));
                ...
                $filename = time() . '_' . Str::random(12) . '.' . $request->file('image')->getClientOriginalExtension();
                $destination = public_path('images\service_images');
                $imagePath = $request->file('image')->move($destination, $filename);
            ...
            $columns = [
                ...
                'service_point_1' => ['id' => $request->input('service_point_1_id'), 'en' => $request->input('service_point_1_en')],
                'service_point_2' => ['id' => $request->input('service_point_2_id'), 'en' => $request->input('service_point_2_en')],
                'service_point_3' => ['id' => $request->input('service_point_3_id'), 'en' => $request->input('service_point_3_en')],
