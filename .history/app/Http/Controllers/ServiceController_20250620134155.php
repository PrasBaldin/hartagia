...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('service')->with('success', 'Layanan berhasil ditambahkan!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('service')->with('success', 'Layanan berhasil diperbarui!');
        } catch (\Exception $e) {
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('service')->with('success', 'Layanan berhasil dihapus!');
    }
}
