    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Translation::insert([
                ...
                ['table_name' => 'portfolios', 'column_name' => 'project_desc', 'row_id' => $portfolio->id, 'language' => 'id', 'translated_text' => $request->desc_id],
                ['table_name' => 'portfolios', 'column_name' => 'project_desc', 'row_id' => $portfolio->id, 'language' => 'en', 'translated_text' => $request->description_en],
