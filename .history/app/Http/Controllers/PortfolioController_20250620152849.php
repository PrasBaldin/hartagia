...
class PortfolioController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // Update terjemahan ke tabel translations
            Translation::updateOrCreate(
                ['table_name' => 'portfolios', 'column_name' => 'project_name', 'row_id' => $portfolio->id, 'language' => 'id'],
                ['translated_text' => $request->project_name_id, 'updated_at' => Carbon::now()]
            );
            Translation::updateOrCreate(
                ['table_name' => 'portfolios', 'column_name' =>
