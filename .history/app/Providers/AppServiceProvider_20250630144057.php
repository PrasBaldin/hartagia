...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('aos', function ($expression) {
            ...
            return "<?php \$ua = request()->header('User-Agent'); \$delayFinal = (preg_match('/Mobile|Android|iPhone/', \$ua)) ? 200 : {$delay}; printf('data-aos=\"%s\" data-aos-delay=\"%d\"%s', '{$type}', \$delayFinal, {$anchor} ? ' data-aos-anchor=\"' . {$anchor} . '\"' : '' ); ?>";
        });
    }
