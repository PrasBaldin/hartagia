...
return [
    ...
    'generic' => [
        ...
        'bulk_delete_nothing'    => 'Kamu belum memilih apa pun untuk dihapus',
        'cancel'                 => 'Batal',
    ...
    'login' => [
        ...
        'signin_below' => 'Sign In Di bawah:',
        'welcome'      => 'Selamat Datang di Halaman Admin',
    ],
    ...
    'settings' => [
        'usage_help'           => 'Kamu dapat menggunakan value dari setiap pengaturan di manapun di website dengan memanggil',
        ...
        'moved_order_up'       => 'Pindah pengaturan :name ke atas',
        'moved_order_down'     => 'Pindah pengaturan :name ke bawah',
        'successfully_removed' => 'Berhasil menghapus :name',
        'group_general'        => 'General',
        'group_admin'          => 'Admin',
        'group_site'           => 'Site',
        'group'                => 'Grup',
        'help_group'           => 'Grup di mana pengaturan ini berlaku',
    ],
    ...
    'media' => [
        ...
        'delete_folder_question' => 'Menghapus folder akan menghapus semua file dan folder di dalamnya',
        'destination_folder'     => 'Folder Tujuan',
        'drag_drop_info'         => 'Drag and drop file atau klik di bawah untuk unggah',
        'error_already_exists'   => 'Maaf, terdapat nama file/folder yang sama di dalam folder tersebut.',
    ...
    'menu_builder' => [
        ...
        'drag_drop_info'       => 'Drag and drop menu item di bawah ini untuk mengurutkannya.',
        ...
        'usage_hint'           => 'Kamu dapat mempertunjukkan menu ini di manapun pada website dengan memanggil',
    ],
    ...
    'database' => [
        ...
        'edit_rows'                 => 'Ubah baris untuk tabel :table di bawah',
        'edit_table'                => 'Ubah tabel :table di bawah',
    ...
    'dimmer' => [
        ...
        'page_text'      => 'Kamu mempunyai :count :string dalam database. Klik tombol di bawah untuk melihat semua halaman.',
        'post'           => 'Post',
        'post_link_text' => 'Lihat semua post',
        'post_text'      => 'Kamu mempunyai :count :string dalam database. Klik tombol di bawah untuk melihat semua post.',
        'user'           => 'User',
        'user_link_text' => 'Lihat semua user',
        'user_text'      => 'Kamu mempunyai :count :string dalam database. Klik tombol di bawah untuk melihat semua user.',
    ],
    ...
    'theme' => [
        'footer_copyright'  => 'Hak Cipta &copy; :year <a href=":url" target="_blank">:name</a>. Hak Cipta Dilindungi.',
    ],
    ...
    'analytics' => [
        ...
        'various_visualizations' => 'Beragam visualisasi',
    ],

    'error' => [
        'symlink_created_text'  => 'Kamu telah membuatkan symlink untukmu.',
