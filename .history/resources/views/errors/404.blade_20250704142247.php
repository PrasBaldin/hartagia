...
<body class="relative font-sans antialiased min-h-screen overflow-hidden">
    ...
    <div class="relative z-10 h-screen flex items-center justify-center lg:justify-end px-6 lg:px-20 bg-gray-800/20 backdrop-blur-sm">
        <div class="text-center lg:text-left lg:w-1/2">
            <h1 class="text-6xl uppercase tracking-widest font-bold text-gray-700">
