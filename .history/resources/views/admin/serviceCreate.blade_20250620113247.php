    ...
    <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
        ...
        <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
            ...
            <div>
                ...
                <textarea name="service_content_id" id="service_content_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="service_content_en" id="service_content_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"></textarea>
            </div>
