        ...
        <div x-data="{ open: false }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('setting.update.contact') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-4">
                        <label for="contact_email" class="block mb-1 font-medium">Email Kontak</label>
                        <input type="email" name="contact_email" class="w-full border rounded px-3 py-2" placeholder="Email Kontak" value="{{ $setting->contact_email }}">
                    </div>
                    <div class="mb-4">
