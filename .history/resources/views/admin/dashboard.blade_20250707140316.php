...
@section('content')
    <div class="flex flex-col items-center justify-center min-h-[60vh]">
        ...
        {{-- Total Visitor --}}
        <div class="flex flex-col md:flex-row gap-6 max-w-4xl mb-4">
        ...
        <div class="w-full max-w-4xl mb-10">
            <div class="bg-white p-6 rounded shadow">
                <h2 class="text-2xl font-semibold mb-4">Statistik Bulanan</h2>
                @if (count($monthlyStats) > 0)
                    <canvas id="monthlyStatsChart" width="400" height="200"></canvas>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            var monthlyStats = {!! json_encode($monthlyStats) !!};
        ...
        <div class="mb-6 md:mb-0">
            <h2 class="text-3xl font-bold mb-2">Statistik Website</h2>
            <p class="text-lg text-gray-600 mb-6">Kelola dan pantau statistik website Anda.</p>
        </div>
