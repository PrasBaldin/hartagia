            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('setting.update.contact') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" class="w-full border rounded px-3 py-2" placeholder="Email Kontak" value="{{ $setting->contact_email }}">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1 font-medium">Alamat Kantor</label>
                        <input type="text" class="w-full border rounded px-3 py-2" placeholder="Alamat Kantor" value="{{ $setting->office_address }}">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1 font-medium">Facebook</label>
                        <input type="url" class="w-full border rounded px-3 py-2" placeholder="Link Facebook" value="{{ $setting->facebook_link }}">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1 font-medium">Instagram</label>
                        <input type="url" class="w-full border rounded px-3 py-2" placeholder="Link Instagram" value="{{ $setting->instagram_link }}">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1 font-medium">Tiktok</label>
                        <input type="url" class="w-full border rounded px-3 py-2" placeholder="Link Twitter" value="{{ $setting->tiktok_link }}">
                    </div>
        ...
        <div x-data="{ open: false }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('setting.update.password') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-4">
                        <label class="block mb-1 font-medium">Password Sekarang</label>
                        <input type="password" class="w-full border rounded px-3 py-2" placeholder="Password Sekarang">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" class="w-full border rounded px-3 py-2" placeholder="Konfirmasi Password">
                        </div>
                        <div class="mb-4">
