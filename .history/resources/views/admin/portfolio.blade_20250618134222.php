...
<div class="p-8 bg-white rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-2xl font-extrabold mb-10 text-center tracking-tight">Daftar Portfolio</h2>
        <a href="{{ route('admin.portfolio.create') }}" class="bg-blue-500 py-4 px-2 rounded-lg">Tambah Portfolio</a>
    </div>
