...
<div class="p-8 bg-white rounded-lg shadow-md">
    <img src="{{ asset('storage/' . $service->image) }}" alt="image.jpg" class="w-full h-64 object-cover rounded-lg mb-6">
    <h2>{{ $service->service_name ? $service->service_name->translated_text : 'title' }}</h2>
</div>
@endsection
