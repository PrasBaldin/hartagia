        ...
        <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
            ...
            <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
                ...
                <div>
                    ...
                    <input name="service_point_1_id" id="service_point_1_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400">
                    <input name="service_point_2_id" id="service_point_2_id" class="w-full px-4 py-3 my-4 border rounded-lg focus:ring-green-400">
                    <input name="service_point_3_id" id="service_point_3_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400">

                    <label for="service_content_id" class="block mt-4 mb-2 text-base font-semibold">Konten (Indonesia)</label>
                    <textarea name="service_content_id" id="service_content_id" class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input name="service_point_en" en="service_point_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400">

                    <label for="service_content_en" class="block mt-4 mb-2 text-base font-semibold">Content (English)</label>
                    <textarea name="service_content_en" id="service_content_en" class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400"></textarea>
                </div>
