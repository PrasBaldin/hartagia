...
<li class="inline-flex items-center">
    ...
    <a href="{{ route('services.index') }}" class="text-gray-500 hover:text-gray-700 transition">Layanan</a>
    <span class="mx-2 text-gray-500">/</span>
...
<div class="flex flex-col justify-center items-center">
    <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
        ...
        <form action="{{ route('service.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div>
                ...
                <input name="service_desc_id" id="service_desc_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"
                    value="{{ isset($translations['service_desc_id']) ? $translations['service_desc_id'] : '' }}">
            ...
            <div>
                ...
                <input name="service_desc_en" id="service_desc_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"
                    value="{{ isset($translations['service_desc_en']) ? $translations['service_desc_en'] : '' }}">
