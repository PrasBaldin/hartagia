        ...
        <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
            ...
            <form action="{{ route('admin.service.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
                ...
                <div>
                    ...
                    <input name="service_point_1_id" id="service_point_1_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400" value="{{ isset($translations['service_point_1_id']) ? $translations['service_point_1_id'] : '' }}" placeholder="Poin 1 ...">
                    <input name="service_point_2_id" id="service_point_2_id" class="w-full px-4 py-3 my-4 border rounded-lg focus:ring-green-400" value="{{ isset($translations['service_point_2_id']) ? $translations['service_point_2_id'] : '' }}" placeholder="Poin 2 ...">
                    <input name="service_point_3_id" id="service_point_3_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400" value="{{ isset($translations['service_point_3_id']) ? $translations['service_point_3_id'] : '' }}" placeholder="Poin 3 ...">

                    <label for="service_content_id" class="block mt-4 mb-2 text-base font-semibold">Konten (Indonesia)</label>
                    <textarea name="service_content_id" id="service_content_id" class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400">{{ isset($translations['service_content_id']) ? $translations['service_content_id'] : '' }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="service_content_en" id="service_content_en" class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400">{{ isset($translations['service_content_en']) ? $translations['service_content_en'] : '' }}</textarea>
                </div>
