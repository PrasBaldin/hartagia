...
<div class="flex flex-col md:flex-row justify-center items-start gap-6">
    ...
    <div class="p-8 bg-white rounded-lg shadow-md w-1/4">
        <div class="flex flex-col gap-4 items-center">
            <a href="{{ route('service.edit', $service->id) }}" class="w-full items-center center bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold py-2 px-4 rounded-lg flex items-center gap-2 transition duration-300">
