            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('setting.update.password') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="confirm_password" class="block mb-1 font-medium">Konfirmasi Password</label>
                            <input type="password" name="confirm_password" class="w-full border rounded px-3 py-2" placeholder="Konfirmasi Password">
                        </div>
                        <div class="mb-4">
