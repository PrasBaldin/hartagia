...
<div class="flex flex-col justify-center items-center">
    <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
        ...
        <form action="{{ route('admin.service.update') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
            {{ csrf_field() }}
            ...
            <div>
                ...
                <textarea name="service_desc_id" id="service_desc_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>

                <label for="service_content_id" class="block mt-4 mb-2 text-base font-semibold">Konten (Indonesia)</label>
                <textarea name="service_content_id" id="service_content_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="service_desc_en" id="service_desc_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>

                <label for="service_content_en" class="block mt-4 mb-2 text-base font-semibold">Content (English)</label>
                <textarea name="service_content_en" id="service_content_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>
            </div>
