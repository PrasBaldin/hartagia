...
<div class="p-8 bg-white rounded-lg shadow-md">
    ...
    <table class="w-full border border-gray-300 rounded-lg shadow-md">
        <thead class="bg-gray-200 text-gray-700">
            <tr>
                <th class="px-2 py-4 w-[10px] text-center">No</th>
                <th class="px-2 py-4 w-[20%]">Gambar</th>
                <th class="px-2 py-4 w-[50%]">Nama Proyek</th>
                <th class="px-2 py-4 w-[20%]">Deskripsi</th>
                <th class="px-2 py-4 w-[10%]">Aksi</th>
            </tr>
        </thead>
