...
@section('content')
    <div class="w-full xl:max-w-4xl mb-4 text-center">
        <h1 class="text-5xl font-bold mb-2">Dashboard</h1>
        <p class="text-xl text-gray-500 mb-10">Selamat datang di halaman admin.</p>
    </div>

    {{-- Total Visitor --}}
    <div class="w-full xl:max-w-4xl mb-4">
        <p class="text-lg text-gray-600 mb-4 text-center">Total Pengunjung Seluruh Waktu: <span class="font-bold text-green-600">{{ $totalVisitorCount }}</span></p>
        <div class="flex flex-col md:flex-row gap-6 justify-between">
            <div class="lg:w-72 bg-white p-4 rounded shadow">
    ...
    {{-- Weekly Stats --}}
    <div x-data="{ open: true }" class="w-full xl:max-w-4xl mb-4">
    ...
    {{-- Monthly Stats --}}
    <div x-data="{ open: true }" class="w-full xl:max-w-4xl mb-10">
        <div class="bg-white p-6 rounded shadow">
            <button @click="open = !open" class="text-left w-full text-2xl font-semibold mb-4 flex justify-between items-center">
                Statistik Bulanan
                <span x-text="open ? '−' : '+'"></span>
    ...
    <div class="flex flex-col md:flex-row gap-6 justify-between w-full max-w-4xl">
        {{-- Layanan --}}
        <a href="{{ route('admin.service.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
        ...
        {{-- Portofolio --}}
        <a href="{{ route('admin.portfolio.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
        ...
        {{-- Pengaturan Website --}}
        <a href="{{ route('admin.setting.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
            <i class="fas fa-cog text-4xl text-teal-500 mb-4"></i>
