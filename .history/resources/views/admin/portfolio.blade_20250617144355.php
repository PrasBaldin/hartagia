        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ asset('storage/' . $portfolio->image1) }}" alt="{{ $portfolio->image_1 }}" width="100">
                    @else
                    Tidak ada gambar
                    @endif
                </td>
                <td>{{ $portfolio->project_name->translated_text }}</td>
                <td>{{ $portfolio->project_desc->translated_text }}</td>
                <td>
