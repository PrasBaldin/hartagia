...
<div class="p-8 bg-white rounded-lg shadow-md">
    ...
    <table class="w-full border border-gray-200 rounded-lg shadow-md border-separate border-spacing-0">
        <thead class="bg-gray-200 text-gray-700 border-b border-gray-200">
            <tr>
                <th class="px-2 py-4 w-[10px] border border-gray-200 rounded-tl-lg">No</th>
                <th class="px-2 py-4 w-[20%] border border-gray-200">Gambar</th>
                <th class="px-2 py-4 w-[50%] border border-gray-200">Nama Proyek</th>
                <th class="px-2 py-4 w-[20%] border border-gray-200">Deskripsi</th>
                <th class="px-2 py-4 w-[10%] border border-gray-200 rounded-tr-lg">Aksi</th>
            </tr>
        </thead>
        <tbody>
            @foreach($portfolios as $index => $portfolio)
            <tr class="{{ $index % 2 === 0 ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-200 border-t border-gray-300">
                <td class="text-center border border-gray-200">{{ $index + 1 }}</td>
                ...
                <td class="border border-gray-200 p-4">{{ $portfolio->project_name ? $portfolio->project_name->translated_text : '-' }}</td>
                <td class="border border-gray-200 p-4">{{ $portfolio->project_desc ? $portfolio->project_desc->translated_text : '-' }}</td>
