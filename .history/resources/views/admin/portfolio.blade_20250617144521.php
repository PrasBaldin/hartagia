        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ $portfolio->image1 }}" alt="Portfolio Image" width="100">
                    @else
                    Tidak ada gambar
                    @endif
                </td>
                <td>{{ optional($portfolio->project_name)->translated_text ?? '-' }}</td>
                <td>{{ optional($portfolio->project_desc)->translated_text ?? '-' }}</td>
                <td>
