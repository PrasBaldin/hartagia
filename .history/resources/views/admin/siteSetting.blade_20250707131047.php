...
@section('content')
    ...
    <div class="p-8 mt-6 bg-white rounded-lg shadow-md space-y-8">
        ...
        <div x-data="{ open: true }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('admin.setting.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 flex items-center space-x-6 items-baseline">
                        <div>
        ...
        <div x-data="{ open: false }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('admin.setting.update.contact') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-4">
                        <label for="contact_email" class="block mb-1 font-medium">Email</label>
                        <input type="email" name="contact_email" class="w-full border rounded px-3 py-2" placeholder="Email" value="{{ $setting->contact_email }}">
                    </div>
                    <div class="mb-4">
                        <label for="contact_phone" class="block mb-1 font-medium">Telepon</label>
                        <input type="number" name="contact_phone" class="w-full border rounded px-3 py-2" placeholder="Telepon" value="{{ $setting->contact_phone }}">
                    </div>
                    <div class="mb-4">
                        <label for="contact_wa" class="block mb-1 font-medium">No. WhatsApp</label>
                        <input type="number" name="contact_wa" class="w-full border rounded px-3 py-2" placeholder="No. WhatsApp" value="{{ $setting->contact_wa }}">
                    </div>
                    <div class="mb-4">
                        <label for="office_address" class="block mb-1 font-medium">Alamat Kantor</label>
                        <input type="text" name="office_address" class="w-full border rounded px-3 py-2" placeholder="Alamat Kantor" value="{{ $setting->office_address }}">
                    </div>
                    <div class="mb-4">
                        <label for="facebook_url" class="block mb-1 font-medium">Facebook</label>
                        <input type="url" name="facebook_url" class="w-full border rounded px-3 py-2" placeholder="Link Facebook" value="{{ $setting->facebook_url }}">
                    </div>
                    <div class="mb-4">
                        <label for="instagram_url" class="block mb-1 font-medium">Instagram</label>
                        <input type="url" name="instagram_url" class="w-full border rounded px-3 py-2" placeholder="Link Instagram" value="{{ $setting->instagram_url }}">
                    </div>
                    <div class="mb-4">
                        <label for="tiktok_url" class="block mb-1 font-medium">Tiktok</label>
                        <input type="url" name="tiktok_url" class="w-full border rounded px-3 py-2" placeholder="Link Twitter" value="{{ $setting->tiktok_url }}">
                    </div>
        ...
        <div x-data="{ open: false }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('admin.setting.update.password') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-4">
