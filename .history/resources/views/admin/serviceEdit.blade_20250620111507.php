        ...
        <form action="{{ route('admin.service.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
            ...
            <div>
                ...
                <input type="text" name="service_name_id" id="service_name_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"
                    value="{{ old('service_name_id', $service->translation('service_name', 'id') ? $service->translation('service_name', 'id')->translated_text : '') }}">
                ...
                {{ old('service_desc_id', $service->translation('service_desc', 'id') ? $service->translation('service_desc', 'id')->translated_text : '') }}
                </textarea>
                ...
                {{ old('service_content_id', $service->translation('service_content', 'id') ? $service->translation('service_content', 'id')->translated_text : '') }}
                </textarea>
            </div>
