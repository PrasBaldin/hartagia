            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('admin.setting.update.contact') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="contact_phone" class="w-full border rounded px-3 py-2" placeholder="Telepon" value="{{ $setting->contact_phone }}">
                    </div>
                    <div class="mb-4">
                        <label for="contact_wa" class="block mb-1 font-medium">No. WhatsApp</label>
                        <input type="text" name="contact_wa" class="w-full border rounded px-3 py-2" placeholder="No. WhatsApp" value="{{ $setting->contact_wa }}">
                    </div>
                    <div class="mb-4">
