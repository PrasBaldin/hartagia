...
<div class="p-8 bg-white rounded-lg shadow-md">
    ...
    <table class="w-full border border-gray-300 rounded-lg shadow-md border-separate border-spacing-0">
        <thead class="bg-gray-200 text-gray-700 border-b border-gray-400">
            <tr>
                <th class="px-2 py-4 w-[10px] border border-gray-400 rounded-tl-lg">No</th>
                ...
                <th class="px-2 py-4 w-[10%] border border-gray-400 rounded-tr-lg">Aksi</th>
            </tr>
        </thead>
        <tbody>
