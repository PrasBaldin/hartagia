            ...
            <form action="{{ route('admin.portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
                ...
                <div class="col-span-2 mb-6">
                    ...
                    @if ($portfolio->image_1)
                        ...
                        <img src="{{ asset($portfolio->image_1) }}" alt="Gambar Portofolio" class="mt-2 mb-4 w-10 h-auto rounded-lg">
                    @endif
                ...
                @for ($i = 2; $i <= 5; $i++)
                    <div class="col-span-2 mb-6">
                        ...
                        @if (!empty($portfolio->$field))
                            ...
                            <img src="{{ asset($portfolio->$field) }}" alt="Gambar Tambahan {{ $i - 1 }}" class="mt-2 mb-4 w-10 h-auto rounded-lg">
                        @endif
                        <p class="mt-2 text-sm">Ubah gambar:</p>
