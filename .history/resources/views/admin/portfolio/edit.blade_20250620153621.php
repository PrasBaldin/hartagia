...
<div class="flex flex-col justify-center items-center">
    <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
        ...
        <form action="{{ route('portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div>
                ...
                <input type="text" name="project_name_id" id="project_name_id" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"
                    value="{{ isset($translations['project_name_id']) ? $translations['project_name_id'] : '' }}">
            ...
            <div>
                ...
                <input type="text" name="project_name_en" id="project_name_en" class="w-full px-4 py-3 border rounded-lg focus:ring-green-400"
                    value="{{ isset($translations['project_name_en']) ? $translations['project_name_en'] : '' }}">
            ...
            <div class="col-span-2">
                ...
                <p class="mt-2 text-sm">Gambar saat ini: <a href="{{ asset('storage/' . $portfolio->image_1) }}" target="_blank">Lihat</a></p>
                @endif
            </div>
