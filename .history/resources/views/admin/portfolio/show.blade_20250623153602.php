    ...
    <div class="flex flex-col md:flex-row justify-center items-start gap-6">
        <div class="p-8 bg-white rounded-lg shadow-md w-3/4">
            <div class="flex flex-col mb-6">
                <!-- image utama -->
                <div class="w-full lg:max-h-[400px] rounded-lg overflow-hidden bg-gray-100 shadow">
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    thumbnails.forEach(container => {
                        ...
                        container.addEventListener('click', () => {
                            ...
                            // Ganti gambar setelah delay sedikit
                            setTimeout(() => {
                                mainImage.src = img.src;

                                // Saat gambar baru selesai dimuat, fade-in
                                mainImage.onload = () => {
