...
@section('content')
    <div class="flex flex-col justify-center items-center">
        <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
            ...
            <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6 p-6">
                {{ csrf_field() }}
                ...
                <div class="col-span-2 grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="image_extra[]" class="block mb-2 font-semibold">Gambar Tambahan (Maksimal 4)</label>
