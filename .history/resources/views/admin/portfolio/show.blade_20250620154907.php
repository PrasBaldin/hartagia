    ...
    <div class="p-8 bg-white rounded-lg shadow-md w-3/4">
        <div class="flex flex-col mb-6">
            ...
            <div class="flex flex-row justify-between items-center mt-4">
                <img src="{{ asset('storage/' . $portfolio->image_2) }}" alt="image_2.jpg" class="w-1/3 object-cover rounded-lg">
                <img src="{{ asset('storage/' . $portfolio->image_3) }}" alt="image_3.jpg" class="w-1/3 object-cover rounded-lg">
                <img src="{{ asset('storage/' . $portfolio->image_4) }}" alt="image_4.jpg" class="w-1/3 object-cover rounded-lg">
                <img src="{{ asset('storage/' . $portfolio->image_5) }}" alt="image_5.jpg" class="w-1/3 object-cover rounded-lg">
            </div>
        </div>
