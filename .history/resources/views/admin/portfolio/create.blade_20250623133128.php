        ...
        <div class="w-full bg-white backdrop-blur-md rounded-lg shadow-lg border px-4 py-8 relative overflow-hidden">
            ...
            <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" name="project_name_id" id="project_name_id"
                        class="w-full px-4 py-3 border rounded-lg focus:ring-green-400">

                    <label for="project_desc_id" class="block mt-4 mb-2 text-base font-semibold">Deskripsi
                        (Indonesia)</label>
                    <textarea name="project_desc_id" id="project_desc_id"
                        class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>

                    <label for="project_content_id" class="block mt-4 mb-2 text-base font-semibold">Konten
                        (Indonesia)</label>
                    <textarea name="project_content_id" id="project_content_id"
                        class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>
                </div>
                ...
                <div>
                    ...
                    <label for="project_desc_en" class="block mt-4 mb-2 text-base font-semibold">Description
                        (English)</label>
                    <textarea name="project_desc_en" id="project_desc_en"
                        class="w-full px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>

                    <label for="project_content_en" class="block mt-4 mb-2 text-base font-semibold">Content
                        (English)</label>
                    <textarea name="project_content_en" id="project_content_en"
                        class="w-full min-h-[150px] px-4 py-3 border rounded-lg focus:ring-green-400 resize-none"></textarea>
                </div>
                ...
                <div class="col-span-2 grid grid-cols-2 gap-4">
                    <!-- Gambar 1 (wajib) -->
                    <div>
                        <label for="image_1" class="block mb-2 font-semibold">Gambar 1 (Wajib)</label>
                    ...
                    @for ($i = 2; $i <= 5; $i++)
                        <div>
                            <label for="image_{{ $i }}" class="block mb-2 font-semibold">Gambar
                                {{ $i }} (Opsional)</label>
