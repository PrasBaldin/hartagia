...
<div class="flex flex-col md:flex-row justify-center items-start gap-6">
    <div class="p-8 bg-white rounded-lg shadow-md w-3/4">
        ...
        <p class="text-gray-600 mb-4">{{ $portfolio->portfolio_desc ? $portfolio->portfolio_desc->translated_text : 'description' }}</p>
        <div class="text-gray-700">
            @php
            $content = isset($portfolio->portfolio_content) ? $portfolio->portfolio_content->translated_text : '';
            $lines = explode("\n", $content);
            @endphp
