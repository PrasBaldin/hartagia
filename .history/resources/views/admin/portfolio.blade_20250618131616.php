            ...
            <tr>
                ...
                <td>
                    <div class="flex flex-col gap-2">
                        <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg flex items-center gap-2">
                            <i class="fas fa-eye"></i> Lihat
                        </a>

                        <a href="{{ route('admin.portfolio.edit', $portfolio->id) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-semibold py-2 px-4 rounded-lg flex items-center gap-2">
                        ...
                        <form id="delete-form-{{ $portfolio->id }}" action="{{ route('admin.portfolio.delete', $portfolio->id) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                            <button type="button" class="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg flex items-center gap-2" onclick="confirmDelete({{ $portfolio->id }})">
