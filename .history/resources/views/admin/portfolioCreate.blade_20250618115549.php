...
<div class="flex flex-col justify-center items-center">
    <div class="w-full bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border p-10 relative overflow-hidden">
        <h2 class="text-4xl font-extrabold mb-10 text-center tracking-tight">Tambah Portfolio</h2>
