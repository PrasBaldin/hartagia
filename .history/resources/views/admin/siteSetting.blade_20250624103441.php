            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('setting.update.contact') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="contact_phone" class="w-full border rounded px-3 py-2" placeholder="Telepon" value="{{ $setting->contact_email }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="facebook_url" class="w-full border rounded px-3 py-2" placeholder="Link Facebook" value="{{ $setting->facebook_link }}">
                    </div>
                    <div class="mb-4">
                        <label for="instagram_url" class="block mb-1 font-medium">Instagram</label>
                        <input type="url" name="instagram_url" class="w-full border rounded px-3 py-2" placeholder="Link Instagram" value="{{ $setting->instagram_link }}">
                    </div>
                    <div class="mb-4">
                        <label for="tiktok_url" class="block mb-1 font-medium">Tiktok</label>
                        <input type="url" name="tiktok_url" class="w-full border rounded px-3 py-2" placeholder="Link Twitter" value="{{ $setting->tiktok_link }}">
                    </div>
