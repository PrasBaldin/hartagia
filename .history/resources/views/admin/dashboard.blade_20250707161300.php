    ...
    <div class="lg:max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="w-full lg:max-w-4xl mb-4">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-between">
                <div class="xl:w-72 bg-white p-4 rounded shadow">
        ...
        <div class="flex flex-col md:flex-row gap-6 justify-between w-full lg:max-w-4xl">
            {{-- Layanan --}}
            <a href="{{ route('admin.service.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center xl:w-72 hover:shadow-lg transition-shadow">
            ...
            {{-- Portofolio --}}
            <a href="{{ route('admin.portfolio.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center xl:w-72 hover:shadow-lg transition-shadow">
            ...
            {{-- Pengaturan Website --}}
            <a href="{{ route('admin.setting.index') }}" class="bg-white rounded-lg shadow-md px-10 lg:px-12 py-8 flex flex-col items-center xl:w-72 hover:shadow-lg transition-shadow">
                <i class="fas fa-cog text-4xl text-teal-500 mb-4"></i>
