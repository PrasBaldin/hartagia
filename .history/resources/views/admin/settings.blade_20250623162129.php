...
@section('content')
    <div class="p-8 mt-6 bg-white rounded-lg shadow-md space-y-8">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="site_description" class="w-full border rounded px-3 py-2" rows="2">{{ $setting->site_description }}</textarea>
                    </div>
        ...
        <div x-data="{ open: false }" class="border rounded mb-4">
            ...
            <div x-show="open" class="px-6 py-4" x-transition>
                <form method="POST" action="{{ route('settings.update.contact') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-4">
