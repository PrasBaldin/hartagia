<footer class="absolute bottom-0 left-0 right-0 text-center text-gray-600 pl-20 lg:pl-0">
    <p class="px-4 pb-2">&copy; {{ date('Y') }} <a href="/{{ app()->getLocale() }}" class="text-green-700 hover:text-green-500 font-bold">PT. Harta Gemilang Aselindo</a>. {{ __('footer.rights') }}</p>
</footer>
