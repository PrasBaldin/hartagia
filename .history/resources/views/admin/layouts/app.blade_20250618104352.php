...
<body>
    <div id="app">
        ...
        <div class="flex" x-data="{ open: true }">
            <!-- Sidebar -->
            <aside :class="open ? 'w-64' : 'w-16'" class="h-screen bg-gray-900 text-white transition-all duration-300 p-4">
            ...
            <main class="flex-1 p-6">
                ...
                <p>Sidebar kini bisa diminimize dengan TailwindCSS dan Alpine.js! 🚀</p>
            </main>
        </div>
