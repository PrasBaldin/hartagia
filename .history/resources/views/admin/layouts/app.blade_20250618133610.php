...
<body>
    <div id="app">
        ...
        <div class="flex">
            <!-- Sidebar -->
            <div id="sidebarOverlay" class="w-59 transition-all duration-300"></div>
            <aside id="sidebar" class="w-59 h-screen fixed left-0 top-0 z-20 bg-gray-900 text-white transition-all duration-300 p-4">
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            sidebar.classList.toggle("w-59");
            sidebar.classList.toggle("w-16");
            sidebarOverlay.classList.toggle("w-59");
