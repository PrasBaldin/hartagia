...
<body>
    <div id="app">
        <nav class="bg-gray-800 text-white flex justify-between items-center px-6 py-4 z-50">
        ...
        <div class="flex">
            <!-- Sidebar -->
            <div class="w-64"></div>
            <aside id="sidebar" class="w-64 h-screen absolute left-0 top-0 z-10 bg-gray-900 text-white transition-all duration-300 p-4">
                <ul id="sidebarMenu">
                    <li class="mb-2">
