...
<body>
    <div id="app">
        <div class="bg-gray-800 text-white flex justify-between items-center px-6 py-4 relative z-30"></div>
        <nav class="fixed top-0 w-full bg-gray-800 text-white flex justify-between items-center px-6 py-4 relative z-50">
        ...
        <div class="flex">
            <!-- Sidebar -->
            <div id="sidebarOverlay" class="w-64 transition-all bg-gray-900 duration-300 p-4"></div>
            <aside id="sidebar" class="w-64 h-auto fixed left-0 top-0 z-20 bg-gray-900 text-white transition-all duration-300 p-4">
