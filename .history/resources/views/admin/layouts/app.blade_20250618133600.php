...
<body>
    <div id="app">
        ...
        <div class="flex">
            <!-- Sidebar -->
            <div id="sidebarOverlay" class="w-58 transition-all duration-300"></div>
            <aside id="sidebar" class="w-58 h-screen fixed left-0 top-0 z-20 bg-gray-900 text-white transition-all duration-300 p-4">
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            sidebarOverlay.classList.toggle("w-58");
