...
<body>
    <div id="app">
        <nav class="bg-gray-800 text-white flex justify-between items-center px-6 py-4 relative z-50">
        ...
        <div class="flex">
            <!-- Sidebar -->
            <div id="sidebarOverlay" class="w-64 transition-all duration-300 p-4"></div>
            <aside id="sidebar" class="w-64 h-screen absolute left-0 top-0 z-20 bg-gray-900 text-white transition-all duration-300 p-4">
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            if (sidebarOverlay.classList.contains("w-64")) {
                sidebarOverlay.classList.remove("w-64");
                sidebarOverlay.classList.add("w-16");
            } else {
                sidebarOverlay.classList.remove("w-16");
                sidebarOverlay.classList.add("w-64");
            }
        }
