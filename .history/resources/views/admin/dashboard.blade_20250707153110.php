...
@section('content')
    <div class="flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <div class="flex flex-col md:flex-row gap-6 justify-between w-full max-w-4xl">
            {{-- Layanan --}}
            <a href="{{ route('admin.service.index') }}" class="bg-white rounded-lg shadow-md px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
            ...
            {{-- Portofolio --}}
            <a href="{{ route('admin.portfolio.index') }}" class="bg-white rounded-lg shadow-md px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
            ...
            {{-- Pengaturan Website --}}
            <a href="{{ route('admin.setting.index') }}" class="bg-white rounded-lg shadow-md px-12 py-8 flex flex-col items-center lg:w-72 hover:shadow-lg transition-shadow">
                <i class="fas fa-cog text-4xl text-teal-500 mb-4"></i>
