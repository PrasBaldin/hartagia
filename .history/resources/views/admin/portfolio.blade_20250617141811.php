...
<div class="container mt-4">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            @php
            $project_name = $portfolio->translations->where('language', 'id')->where('column_name', 'project_name')->first();
            $project_desc = $portfolio->translations->where('language', 'id')->where('column_name', 'project_desc')->first();
            @endphp
            <tr>
                <td>{{ $index + 1 }}</td>
                <td>
