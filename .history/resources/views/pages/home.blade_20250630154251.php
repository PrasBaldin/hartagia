                    ...
                    <div class="pt-10 pb-20">
                        ...
                        <div class="mt-6">
                            ...
                            <div @aos('fade-up', 500, '#heroSection')>
                                <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/80 text-white hover:text-green-700 border-2 border-white hover:border-green-700 ml-4 hover:scale-105 transition-transform duration-300">
