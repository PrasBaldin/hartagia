@extends('layouts.app')
@section('content')
<section class="bg-gray-900/50 text-white items-center overflow-hidden">
    <!-- Background Image -->
    <div class="absolute inset-0 h-full bg-[url('/images/bg-1.jpg')] bg-cover bg-center z-[-2]"></div>
    <!-- Overlay Gradient -->
    <div class="absolute inset-0 h-full bg-gradient-to-br from-gray-900/100 to-transparent z-[-1]"></div>
        ...
        <div class="relative md:w-1/2 md:pl-[6rem] lg:pl-[10rem]">
            <div class="flex items-center h-full relative">
                <div class="rounded-lg overflow-hidden w-full h-full md:h-[300px] lg:h-[500px] absolute top-0 z-[1]">
                    <img src="{{ asset('images/img-1.jpg') }}" alt="img-1.jpg" class="w-full h-full object-cover absolute top-0">
                </div>
            </div>
        </div>
    </div>
