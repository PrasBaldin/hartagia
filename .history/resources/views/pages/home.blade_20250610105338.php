...
<section class="bg-gray-900 text-white p-8 items-center">
    <div class="container flex flex-col md:flex-row ">
        ...
        <div class="relative md:w-1/2 md:pl-4">
            <div class="rounded-lg overflow-hidden h-3/4 relative">
                <img src="{{ asset('images/img-1.jpg') }}" alt="Skyscraper" class="w-full h-full absolute top-0">
            </div>
        </div>
