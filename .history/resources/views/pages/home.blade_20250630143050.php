...
@section('content')
    ...
    <section class="py-20 bg-gray-100">
        <div class="container">
            <div id="serviceAnchor1" class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
    ...
    <section class="py-10 bg-gray-100">
        <div class="container">
            <div class="w-full md:w-3/4">
                <h2 class="uppercase tracking-widest text-green-700" @aos('fade-up', 200)>{{ __('about.title') }}</h2>
                <p class="text-2xl md:text-4xl mt-4 font-bold" @aos('fade-up', 300)>{{ __('about.subtitle') }}</p>
            </div>
            <div class="flex flex-col md:flex-row gap-20 justify-start pt-10 md:mt-10">
                <div class="w-full md:w-1/2">
                    <p class="mb-10" @aos('fade-up', 400)>{{ __('about.description.1') }}</p>
                    <p class="mb-10" @aos('fade-up', 500)>{{ __('about.description.2') }}</p>
                    <a href="{{ route('about', ['lang' => app()->getLocale()]) }}" class="btn button-secondary hover:scale-105 transition-transform duration-300" @aos('fade-up', 600)>
                        {{ __('about.learn_more') }}
                    </a>
                </div>
