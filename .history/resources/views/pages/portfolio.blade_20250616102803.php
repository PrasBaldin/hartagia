    ...
    <div class="container mx-auto py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                <a href="#">
                    <img src="{{ asset('images/img-1.jpg') }}" alt="Project 1" class="w-full h-50 object-cover">
                </a>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                <a href="#">
                    <img src="{{ asset('images/portfolio2.jpg') }}" alt="Project 2" class="w-full h-50 object-cover">
                </a>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                <a href="#">
                    <img src="{{ asset('images/portfolio3.jpg') }}" alt="Project 3" class="w-full h-50 object-cover">
                </a>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                <a href="#">
                    <img src="{{ asset('images/portfolio4.jpg') }}" alt="Project 4" class="w-full h-50 object-cover">
                </a>
                <div class="p-6">
