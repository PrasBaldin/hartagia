...
<section class="py-16 bg-gray-100">
    <div class="container">
        <div class="flex flex-col md:flex-row gap-2 justify-between items-center py-10">
            <div class="w-1/2">
                <h2 class="uppercase">{{ __('service.title') }}</h2>
                <p class="text-6xl pr-4 mt-4 text-gray-900 font-bold">{{ __('service.subtitle') }}</p>
            </div>
            <div class="w-1/2">
                <p class="mb-4">{{ __('service.description') }}</p>
