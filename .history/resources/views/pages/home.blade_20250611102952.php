...
<section class="py-20 bg-white relative">
    ...
    <!-- Decorative shapes -->
    <div class="absolute top-20 left-20 w-32 h-32 bg-green-500 rounded-full opacity-30 z-10"></div>
    <div class="absolute bottom-20 right-20 w-40 h-40 bg-green-500 rounded-full opacity-20 z-10"></div>
</section>
