                ...
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        ...
                        <div class="mt-6">
                            ...
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/10 text-white hover:text-green-500 border-2 border-white hover:border-green-500 ml-4">
