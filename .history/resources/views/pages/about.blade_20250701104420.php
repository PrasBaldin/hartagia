            ...
            <div class="flex items-center justify-between flex-col md:flex-row gap-10">
                ...
                <div class="md:w-1/2">
                    ...
                    <h2 class="text-2xl md:text-4xl font-semibold mb-6">
                        {{ __('about.subtitle') }}</h2>
                    <p class="text-gray-700 mb-4">
                        {{ __('about.description.1') }}</p>
                    <p class="text-gray-700 mb-4">
                        {{ __('about.description.2') }}</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="flex flex-col md:flex-row gap-6 justify-center">
                    <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                        ...
                        <h4 class="font-bold mb-2">
                            {{ __('about.mission.1.title') }}</h4>
                        <p class="text-gray-600">
                            {{ __('about.mission.1.description') }}</p>
                    </div>
                    <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                        <span class="text-green-700 text-2xl mb-2 inline-block">
                        ...
                        <h4 class="font-bold mb-2">
                            {{ __('about.mission.2.title') }}</h4>
                        <p class="text-gray-600">
                            {{ __('about.mission.2.description') }}</p>
                    </div>
                    <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                        <span class="text-green-700 text-2xl mb-2 inline-block">
                        ...
                        <h4 class="font-bold mb-2">
                            {{ __('about.mission.3.title') }}</h4>
                        <p class="text-gray-600">
                            {{ __('about.mission.3.description') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-10 justify-center">
                <div class="flex-1 bg-white rounded-lg shadow p-8 border-t-4 border-green-600">
                    <div class="flex items-center mb-4">
                        ...
                        <span class="font-semibold">
                            {{ __('about.superiority.1.title') }}</span>
                    </div>
                ...
                <div class="flex-1 bg-white rounded-lg shadow p-8 border-t-4 border-green-600">
                    <div class="flex items-center mb-4">
                        <span class="text-green-600 mr-2"><i class="fas fa-check-circle"></i></span>
                        <span class="font-semibold">
                            {{ __('about.superiority.2.title') }}</span>
                    </div>
                ...
                <div class="flex-1 bg-white rounded-lg shadow p-8 border-t-4 border-green-600">
                    <div class="flex items-center mb-4">
                        <span class="text-green-600 mr-2"><i class="fas fa-check-circle"></i></span>
                        <span class="font-semibold">
                            {{ __('about.superiority.3.title') }}</span>
                    </div>
