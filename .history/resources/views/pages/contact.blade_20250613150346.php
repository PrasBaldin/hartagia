    ...
    <div class="container">
        <div class="flex items-center justify-between flex-col md:flex-row gap-10 py-20">
            ...
            <div class="mb-6 md:mb-0 max-w-full w-[400px]">
                <div class="bg-gradient-to-br from-green-100 via-white to-green-50 rounded-xl shadow-lg p-1">
            ...
            <div class="md:w-1/2">
                <div class="mb-6">
                    <h2 class="uppercase tracking-widest text-green-700 mb-2 animate-pulse">{{ __('contact.title') }}</h2>
                    <h2 class="text-6xl font-semibold mb-4 bg-gradient-to-r from-green-700 via-green-400 to-green-700 bg-clip-text text-transparent">
                        {{ __('contact.subtitle') }}
                    </h2>
                    <div class="h-1 w-24 bg-gradient-to-r from-green-700 to-green-400 rounded mb-6"></div>
                </div>
                <div class="space-y-6">
                ...
                <div class="mt-10">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.123456789!2d106.8166667!3d-6.2000000!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMTInMDAuMCJTIDEwNsKwNDknMDAuMCJF!5e0!3m2!1sen!2sid!4v1610000000000!5m2!1sen!2sid"
