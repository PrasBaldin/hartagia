    ...
    <section id="about">
        <div class="container mx-auto py-20">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10">
                ...
                <div class="md:w-1/2">
                    <h2 class="uppercase tracking-widest text-green-700 mb-6" @aos('fade-up', 200, '#about')>
                        {{ __('about.title') }}
                    </h2>
    ...
    <section class="bg-white py-20 pb-[15rem]">
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center gap-8">
                <h3 class="uppercase tracking-widest text-green-700 mb-2" @aos('fade-up', 500)>
                    {{ __('about.mission.title') }}
                </h3>
                <h2 class="text-2xl md:text-4xl font-semibold mb-4" @aos('fade-up', 500)>
