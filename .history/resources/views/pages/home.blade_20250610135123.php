@extends('layouts.app')
@section('content')
<section class="bg-green-900/50 text-white items-center">
    <!-- Background Image -->
    <div class="absolute inset-0 h-full bg-[url('/images/bg-1.jpg')] bg-cover bg-center z-[-2] max-h-[541px]"></div>
    <!-- Overlay Gradient -->
    <div class="absolute inset-0 h-full bg-gradient-to-br from-green-900/100 to-transparent z-[-1] max-h-[541px]"></div>
