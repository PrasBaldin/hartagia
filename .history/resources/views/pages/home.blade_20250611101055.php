...
<section class="bg-gradient-to-br from-green-800 to-green-500 text-white py-20">
    <div class="container mx-auto py-10">
        <h1 class="text-center text-6xl font-bold mb-8">Keunggulan dalam Keandalan dan Inovasi</h1>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div class="p-6 rounded-lg">
                ...
                <h2 class="text-4xl font-semibold py-4">Keandalan</h2>
            ...
            <div class="p-6 rounded-lg">
                ...
                <h2 class="text-4xl font-semibold py-4">Inovasi</h2>
            ...
            <div class="p-6 rounded-lg">
                ...
                <h2 class="text-4xl font-semibold py-4">Profesionalisme</h2>
