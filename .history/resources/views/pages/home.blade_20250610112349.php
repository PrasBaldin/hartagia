...
<section class="bg-gray-900 text-white p-8 items-center">
    <div class="container flex flex-col md:flex-row ">
        <div class="md:w-1/2 mb-6 md:mb-0 md:pr-[10rem]">
            <div class="flex items-center h-full">
                <div class="py-[6rem] lg:py-[10rem]">
        ...
        <div class="relative md:w-1/2 md:pl-[10rem]">
            <div class="flex items-center h-full relative">
                <div class="rounded-lg overflow-hidden w-full h-full md:h-[400px] lg:h-[600px] absolute top-0 z-[1]">
