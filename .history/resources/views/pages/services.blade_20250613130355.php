    ...
    <div class="container py-5">
        ...
        <div class="flex flex-col gap-8">
            ...
            <a href="#" class="block group">
                <div class="card w-full shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl flex flex-col md:flex-row items-center">
                    ...
                    <div class="card-body flex-1 p-6">
                        <h5 class="card-title text-2xl font-semibold flex items-center gap-2">
                            Web Development
                        </h5>
