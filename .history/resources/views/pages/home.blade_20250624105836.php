            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($portfolios as $portfolio)
                    ...
                    <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                        <img src="{{ asset('storage/' . $portfolio->image_1) }}" alt="portfolio Image 1" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
