...
<section class="py-20 bg-white">
    <div class="container mx-auto">
        <h2 class="text-center text-4xl font-bold mb-10">{{ __('gallery.title') }}</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-1.jpg') }}" alt="Gallery Image 1" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-2.jpg') }}" alt="Gallery Image 2" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-3.jpg') }}" alt="Gallery Image 3" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-4.jpg') }}" alt="Gallery Image 4" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-5.jpg') }}" alt="Gallery Image 5" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
            <div class="overflow-hidden rounded-lg shadow-lg">
                <img src="{{ asset('images/gallery-6.jpg') }}" alt="Gallery Image 6" class="w-full h-72 object-cover transition-transform duration-300 hover:scale-105">
            </div>
        </div>
    </div>
</section>
