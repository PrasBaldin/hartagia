...
@section('content')
    ...
    <section>
        <div class="container mx-auto py-12 pb-20">
            <h1 class="py-20 md:w-3/4 text-4xl lg:text-6xl pr-20 font-bold leading-tight">
                {{ __('portfolio.headline') }}</h1>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-shadow duration-300 hover:shadow-2xl group">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2 text-gray-900">
                                {{ $portfolio->project_name ? $portfolio->project_name->translated_text : 'value' }}</h3>
                            <p class="text-gray-700 mb-4">
                                {{ $portfolio->project_desc ? $portfolio->project_name->translated_text : 'value' }}</p>
