        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                <div class="flex-shrink-0 p-6 md:p-8">
                    <img src="" alt="img" class="w-[300px] h-[300px] text-blue-500 border-2 border-gray-200 dark:border-gray-700">
                </div>
                <div class="flex-1 p-6">
                    ...
                    <span class="inline-block mt-4 text-blue-600 hover:underline">Learn more &rarr;</span>
                </div>
            </div>
