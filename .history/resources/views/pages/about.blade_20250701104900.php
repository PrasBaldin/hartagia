        ...
        <div class="container mx-auto py-20">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10">
                <div class="mb-6 md:mb-0 max-w-full w-[400px] h-[300px] overflow-hidden relative">
                    <img src="{{ asset('images/img-1.jpg') }}" alt="Logo" class="w-full h-full object-cover" @aos('fade-right', 200)>
                </div>
                <div class="md:w-1/2">
                    <h2 class="uppercase tracking-widest text-green-700 mb-6" @aos('fade-up', 200)>
                        {{ __('about.title') }}
                    </h2>
                    <h2 class="text-2xl md:text-4xl font-semibold mb-6" @aos('fade-up', 300)>
                        {{ __('about.subtitle') }}
                    </h2>
                    <p class="text-gray-700 mb-4" @aos('fade-up', 400)>
                        {{ __('about.description.1') }}
                    </p>
                    <p class="text-gray-700 mb-4" @aos('fade-up', 500)>
