...
@section('content')
        ...
        <div class="container">
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <a href="{{ url(app()->getLocale() . '/services') }}" class="btn button-secondary inline-flex items-center gap-2 hover:scale-105 transition-transform duration-200">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    <img src="{{ asset('images/service-11.jpg') }}" alt="{{ __('service.procurement.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                    <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                        <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.procurement.title') }}</h3>
                        <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.procurement.description') }}</p>
                    </div>
                ...
                <!-- Konstruksi -->
                <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    <img src="{{ asset('images/service-21.jpg') }}" alt="{{ __('service.construction.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                    <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                        <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.construction.title') }}</h3>
                        <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.construction.description') }}</p>
                    </div>
                ...
                <!-- Konsultasi Proyek -->
                <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    <img src="{{ asset('images/service-3.jpg') }}" alt="{{ __('service.consultation.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                    <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                        <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.consultation.title') }}</h3>
                        <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.consultation.description') }}</p>
                    </div>
    ...
    <section class="py-20 bg-gray-100">
        <div class="container">
            ...
            <div class="flex flex-col md:flex-row gap-20 justify-start py-10 md:my-10">
                <div class="w-full md:w-1/2">
                    <p class="mb-10">{{ __('about.description.1') }}</p>
                    <p class="mb-10">{{ __('about.description.2') }}</p>
                    <a href="{{ url(app()->getLocale() . '/about') }}" class="btn button-secondary">
                        {{ __('about.learn_more') }}
                    </a>
                </div>
                <div class="w-full md:w-1/2">
        ...
        <div class="container mx-auto py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="p-6 rounded-lg">
                    <div class="mb-4">
                        <i class="fas fa-check-circle text-2xl lg:text-4xl"></i>
                    </div>
                    <h2 class="text-2xl lg:text-4xl font-semibold py-4">{{ __('about.benefits.reliability_title') }}</h2>
                    <p class="mt-2">{{ __('about.benefits.reliability_desc') }}</p>
                </div>
                <div class="p-6 rounded-lg">
                    <div class="mb-4">
                        <i class="fas fa-lightbulb text-2xl lg:text-4xl"></i>
                    </div>
                    <h2 class="text-2xl lg:text-4xl font-semibold py-4">{{ __('about.benefits.innovation_title') }}</h2>
                    <p class="mt-2">{{ __('about.benefits.innovation_desc') }}</p>
                </div>
                <div class="p-6 rounded-lg">
                    <div class="mb-4">
                        <i class="fas fa-user-tie text-2xl lg:text-4xl"></i>
                    </div>
                    <h2 class="text-2xl lg:text-4xl font-semibold py-4">{{ __('about.benefits.professional_title') }}</h2>
        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <a href="{{ url(app()->getLocale() . '/galleries') }}" class="btn button-secondary">
