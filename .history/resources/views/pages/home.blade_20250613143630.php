    ...
    <div class="container">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                <img src="{{ asset('images/service-11.jpg') }}" alt="{{ __('service.1.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                ...
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.1.title') }}</h3>
                    <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.1.description') }}</p>
                </div>
            ...
            <!-- Konstruksi -->
            <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                <img src="{{ asset('images/service-21.jpg') }}" alt="{{ __('service.2.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.2.title') }}</h3>
                    <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.2.description') }}</p>
                </div>
            ...
            <!-- Konsultasi Proyek -->
            <a href="#" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                <img src="{{ asset('images/service-3.jpg') }}" alt="{{ __('service.3.title') }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-semibold text-white drop-shadow-lg">{{ __('service.3.title') }}</h3>
                    <p class="mt-2 text-white/80 hidden group-hover:block transition-all duration-300">{{ __('service.3.description') }}</p>
                </div>
