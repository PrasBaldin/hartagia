    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <a href="{{ route('services.web-development') }}" class="block group">
                    <div class="card h-100 shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl">
                        <div class="card-body">
                            <h5 class="card-title text-xl font-semibold flex items-center gap-2">
                                <svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path d="M4 4h16v16H4z" />
                                </svg>
                                Web Development
                            </h5>
                            <p class="card-text mt-2 text-gray-700 dark:text-gray-200">
                            ...
                            <span class="inline-block mt-4 text-blue-600 group-hover:underline">Learn more &rarr;</span>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-4">
                <a href="{{ route('services.mobile-app') }}" class="block group">
                    <div class="card h-100 shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl">
                        <div class="card-body">
                            <h5 class="card-title text-xl font-semibold flex items-center gap-2">
            ...
            <div class="col-md-4 mb-4">
                <a href="{{ route('services.uiux') }}" class="block group">
                    <div class="card h-100 shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl">
                        <div class="card-body">
                            <h5 class="card-title text-xl font-semibold flex items-center gap-2">
