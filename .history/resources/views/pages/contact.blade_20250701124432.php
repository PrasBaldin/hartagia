        ...
        <div class="container">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10 py-20">
                ...
                <div class="md:w-1/2">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center space-x-4" @aos('fade-up', 400)>
                        ...
                        <div class="flex items-center space-x-4" @aos('fade-up', 500)>
                            <span class="inline-flex items-center justify-center w-10 h-10 bg-green-700 text-white rounded-full">
                        ...
                        <div class="flex items-center space-x-4" @aos('fade-up', 600)>
