        ...
        <div class="container">
            <div id="serviceHeader" class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                <div class="w-full md:w-1/2">
                    <h2 class="uppercase tracking-widest text-green-700" @aos('fade-up', 200, '#serviceHeader', 250)>{{ __('service.title') }}</h2>
                    <p class="text-6xl mt-4 text-gray-900 font-bold" @aos('fade-up', 300, '#serviceHeader', 250)>{{ __('service.subtitle') }}</p>
                </div>
                <div class="w-full md:w-1/2">
                    <p class="mb-10 text-gray-700" @aos('fade-up', 400, '#serviceHeader', 250)>{{ __('service.description') }}</p>
                    <a href="{{ route('services', ['lang' => app()->getLocale()]) }}" class="btn button-secondary inline-flex items-center gap-2 hover:scale-105 transition-transform duration-300" @aos('fade-up', 500, '#serviceHeader', 250)>
