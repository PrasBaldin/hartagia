...
<section class="py-20 bg-white relative">
    ...
    <!-- Decorative shapes -->
    <div class="hidden lg:!block absolute top-20 left-20 w-32 h-32 bg-green-800/60 rounded-full z-10"></div>
    <div class="hidden lg:!block absolute top-10 left-10 w-20 h-20 bg-green-600/40 rounded-full z-10"></div>
    <div class="hidden lg:!block absolute bottom-20 right-20 w-40 h-40 bg-green-900/60 rounded-full z-10"></div>
    <div class="hidden lg:!block absolute bottom-10 right-10 w-24 h-24 bg-green-700/40 rounded-full z-10"></div>
</section>
