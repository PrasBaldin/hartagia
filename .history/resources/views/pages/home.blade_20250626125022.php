                ...
                @foreach ($services as $service)
                    ...
                    <a href="{{ route('service.show', ['lang' => $lang, 'slug' => $service->slug]) }}" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div class="absolute bottom-0 left-0 p-6">
                            <h3 class="text-2xl font-semibold text-white drop-shadow-[0_1px_1px_rgba(0,0,0,1)]">{{ $caption->translated_text ? $caption->translated_text : 'Untitled' }}</h3>
                            <p class="mt-2 text-white hidden drop-shadow-[0_1px_1px_rgba(0,0,0,1)] group-hover:block transition-all duration-300">{{ $service->service_desc->translated_text }}</p>
                        </div>
