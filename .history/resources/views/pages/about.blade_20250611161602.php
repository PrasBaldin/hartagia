...
<section class="bg-green-50 py-20">
    <div class="container mx-auto py-20">
        <div class="relative">
            <img src="{{ asset('images/service-1.jpg') }}" alt="" class="w-full h-[300px] object-cover rounded-lg absolute inset-0 -top-[18rem]">
        </div>
        <div class="flex flex-col items-center mb-16 mt-[16rem]">
            <h3 class="uppercase tracking-widest text-green-700 mb-2 w-full">Keunggulan</h3>
            <h2 class="text-4xl font-bold mb-4 w-full">Keunggulan dalam Keandalan dan Inovasi</h2>
        </div>
