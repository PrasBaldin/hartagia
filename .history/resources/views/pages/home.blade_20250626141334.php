                ...
                @foreach ($portfolios as $portfolio)
                    <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                        <a href="{{ route('portfolio.show', ['lang' => app()->getLocale(), 'slug' => $Portfolio->slug]) }}" class="block">
                            <img src="{{ asset('storage/' . $Portfolio->image_1) }}" alt="{{ $Portfolio->project_name ? $Portfolio->project_name->translated_text : 'Untitled' }}" class="w-full object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
