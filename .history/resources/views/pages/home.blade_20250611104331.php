...
<section class="py-20 bg-white relative">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-1.jpg') }}" alt="Gallery Image 1" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-2.jpg') }}" alt="Gallery Image 2" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-3.jpg') }}" alt="Gallery Image 3" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-4.jpg') }}" alt="Gallery Image 4" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-5.jpg') }}" alt="Gallery Image 5" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                <img src="{{ asset('images/gallery-6.jpg') }}" alt="Gallery Image 6" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
    ...
    <!-- Decorative shapes -->
    <div class="hidden md:block important absolute top-20 left-20 w-32 h-32 bg-green-800/60 rounded-full z-10"></div>
    <div class="hidden md:block important absolute top-10 left-10 w-20 h-20 bg-green-600/40 rounded-full z-10"></div>
    <div class="hidden md:block important absolute bottom-20 right-20 w-40 h-40 bg-green-900/60 rounded-full z-10"></div>
    <div class="hidden md:block important absolute bottom-10 right-10 w-24 h-24 bg-green-700/40 rounded-full z-10"></div>
</section>
