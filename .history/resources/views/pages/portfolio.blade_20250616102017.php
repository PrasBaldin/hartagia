...
<section>
    <div class="container mx-auto py-12">
        <h2 class="text-3xl font-bold mb-8 text-center">{{ __('portfolio.subtitle') }}</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Portfolio Item 1 -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="{{ asset('images/portfolio1.jpg') }}" alt="Project 1" class="w-full h-48 object-cover">
                <div class="p-6">
                    ...
                    <a href="#" target="_blank" class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">
