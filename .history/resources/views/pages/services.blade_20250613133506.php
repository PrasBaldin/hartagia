    ...
    <div class="container py-20">
        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 py-10">
                <div class="flex-shrink-0 p-6 md:p-8 border-2 border-gray-200 dark:border-gray-700 w-full">
                    <img src="" alt="img" class="w-full h-[200px] md:w-[300px] md:h-[250px] text-blue-500">
                </div>
