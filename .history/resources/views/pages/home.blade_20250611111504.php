@extends('layouts.app')
@section('content')
<section class="parallax-container bg-gray-900/50 text-white items-center">
    <!-- Background Image -->
    <div class="parallax-bg absolute inset-0 h-full bg-[url('/images/bg-1.jpg')] bg-cover bg-center z-[-2] max-h-[544px]"></div>
    <!-- Overlay Gradient -->
