    ...
    <div class="container">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 shadow rounded-lg">
                <img src="{{ asset('images/service-1.jpg') }}" alt="{{ __('service.service1') }}" class="w-full h-50 object-cover rounded-lg">
                <h3 class="text-2xl font-semibold mt-4">{{ __('service.service1') }}</h3>
            </div>

            <!-- Konstruksi -->
            <div class="bg-white p-6 shadow rounded-lg">
                <img src="{{ asset('images/service-2.jpg') }}" alt="{{ __('service.service2') }}" class="w-full h-50 object-cover rounded-lg">
                <h3 class="text-2xl font-semibold mt-4">{{ __('service.service2') }}</h3>
            </div>

            <!-- Konsultasi Proyek -->
            <div class="bg-white p-6 shadow rounded-lg">
                <img src="{{ asset('images/service-3.jpg') }}" alt="{{ __('service.service3') }}" class="w-full h-50 object-cover rounded-lg">
