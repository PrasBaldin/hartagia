    ...
    <section class="py-20 bg-gray-100">
        <div class="container">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Pengadaan Umum -->
                <a href="{{ route('service.show', ['lang' => app()->getLocale(), 'slug' => $service->slug]) }}" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
