        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <a href="#" class="block group">
                    <div class="card h-100 shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl flex flex-row items-center">
            ...
            <div class="col-md-4 mb-4">
                <a href="#" class="block group">
                    <div class="card h-100 shadow-lg transition-transform group-hover:-translate-y-2 group-hover:shadow-2xl flex flex-row items-center">
                        <div class="flex-shrink-0 p-4">
                            <svg class="w-14 h-14 text-pink-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
