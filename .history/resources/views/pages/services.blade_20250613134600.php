        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 py-10">
                <div class="flex-shrink-0 w-full md:w-1/2">
                    <img src="{{ asset('images/service-1.jpg') }}" alt="proc.jpg" class="w-full h-[200px] md:h-[250px] text-blue-500 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 py-10">
                <div class="flex-shrink-0 w-full md:w-1/2">
                    <img src="{{ asset('images/service-2.jpg') }}" alt="construction.jpg" class="w-full h-[200px] md:h-[250px] text-blue-500 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                </div>
                <div class="flex-1 p-6">
                    <h5 class="text-2xl font-semibold flex items-center gap-2">
                        Konstruksi
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 py-10">
                <div class="flex-shrink-0 w-full md:w-1/2">
                    <img src="{{ asset('images/service-3.jpg') }}" alt="consultant.jpg" class="w-full h-[200px] md:h-[250px] text-blue-500 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                </div>
                <div class="flex-1 p-6">
                    <h5 class="text-2xl font-semibold flex items-center gap-2">
                        Consultant
