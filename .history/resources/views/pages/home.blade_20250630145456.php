        ...
        <div class="container mx-auto py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="p-6 rounded-lg">
                    <div class="mb-4" @aos('fade-up', 200)>
                        <i class="fas fa-check-circle text-4xl"></i>
                    </div>
                    <h2 class="text-2xl lg:text-4xl font-semibold mb-4" @aos('fade-up', 300)>{{ __('about.benefits.reliability_title') }}</h2>
                    <p class="pb-4" @aos('fade-up', 400)>{{ __('about.benefits.reliability_desc') }}</p>
                </div>
                <div class="p-6 rounded-lg">
                    <div class="mb-4">
