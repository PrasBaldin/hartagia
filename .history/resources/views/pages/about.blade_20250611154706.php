...
<section class="bg-white py-16">
    <div class="container mx-auto flex flex-col md:flex-row items-center gap-10">
        <div class="md:w-1/2">
            <h3 class="uppercase tracking-widest text-green-700 mb-4">{{ __('about.mission_title') }}</h3>
            <h2 class="text-3xl font-semibold mb-6">{{ __('about.mission_headline') }}</h2>
            <p class="text-lg text-gray-700">{{ __('about.mission_description') }}</p>
        </div>
