                ...
                @foreach ($portfolios as $portfolio)
                    <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                        <a href="{{ route('portfolio.show', ['lang' => app()->getLocale(), 'slug' => $portfolio->slug]) }}" class="block">
                            <img src="{{ asset('storage/' . $portfolio->image_1) }}" alt="{{ $portfolio->project_name ? $portfolio->project_name->translated_text : 'Untitled' }}" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
