...
<section class="bg-gray-900 text-white p-8 items-center">
    <div class="container flex flex-col md:flex-row ">
        ...
        <div class="relative md:w-1/2 md:pl-8">
            <div class="flex items-center h-full">
                <div class="w-1/2 bg-gray-200 p-8 relative">
                    <img src="{{ asset('images/img-1.jpg') }}" alt="Buildings" class="absolute left-1/2 -translate-x-1/2 top-0 w-80 h-auto">
                </div>
                <!-- <div class="rounded-lg overflow-hidden w-full h-full md:h-[500px] relative">
                    <img src="{{ asset('images/img-1.jpg') }}" alt="Skyscraper" class="absolute left-1/2 -translate-x-1/2 top-0 w-80 h-auto">
                </div> -->
            </div>
        </div>
