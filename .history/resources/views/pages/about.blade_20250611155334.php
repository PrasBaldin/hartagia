        ...
        <div class="flex flex-col items-center text-center gap-8">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center">
                <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                    ...
                    <h4 class="font-bold mb-2">{{ __('about.mission.point1.title') }}</h4>
                    <p class="text-gray-600">{{ __('about.mission.point1.desc') }}</p>
                </div>
                <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                    <span class="text-green-700 text-2xl mb-2 inline-block">
                        <i class="fas fa-users"></i>
                    </span>
                    <h4 class="font-bold mb-2">{{ __('about.mission.point2.title') }}</h4>
                    <p class="text-gray-600">{{ __('about.mission.point2.desc') }}</p>
                </div>
                <div class="bg-green-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                    <span class="text-green-700 text-2xl mb-2 inline-block">
                        <i class="fas fa-lightbulb"></i>
                    </span>
                    <h4 class="font-bold mb-2">{{ __('about.mission.point3.title') }}</h4>
                    <p class="text-gray-600">{{ __('about.mission.point3.desc') }}</p>
                </div>
            </div>
        </div>
    </div>
