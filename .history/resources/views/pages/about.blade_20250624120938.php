...
@section('content')
        ...
        <div class="container mx-auto py-20">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10">
                ...
                <div class="md:w-1/2">
                    ...
                    <h2 class="text-2xl md:text-4xl font-semibold mb-6">{{ __('about.subtitle') }}</h2>
    ...
    <section class="bg-white pt-20">
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center gap-8">
                ...
                <h2 class="text-2xl md:text-4xl font-semibold mb-4">{{ __('about.mission.headline') }}</h2>
    ...
    <section class="bg-green-50 py-20">
        <div class="container mx-auto py-20">
            <div class="relative">
                <img src="{{ asset('images/img-2.jpg') }}" alt="img.jpg" class="w-full h-[300px] object-cover rounded-lg absolute inset-0 -top-[100px]">
            </div>
