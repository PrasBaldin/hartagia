                ...
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        ...
                        <div class="mt-6">
                            ...
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/10 text-gray-100 border border-white/20 hover:border-white/30 ml-4">
