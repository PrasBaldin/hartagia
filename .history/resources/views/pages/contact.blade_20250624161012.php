        ...
        <div class="container">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10 py-20">
                ...
                <div class="mb-6 md:mb-0 max-w-full w-[400px]">
                    <form class="bg-white rounded-lg shadow-md p-10 space-y-4">
                ...
                <div class="md:w-1/2">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center space-x-4">
                            ...
                            <span class="text-lg">{{ $contact->contact_email ? $contact->contact_email : '-' }}</span>
                        </div>
                        <div class="flex items-center space-x-4">
                            <span class="inline-flex items-center justify-center w-10 h-10 bg-green-700 text-white rounded-full">
                                <i class="fas fa-phone-alt"></i>
                            </span>
                            <span class="text-lg">{{ $contact->contact_phone ? $contact->contact_phone : '-' }}</span>
                        </div>
                        <div class="flex items-center space-x-4">
