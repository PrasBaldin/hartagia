...
<section class="bg-gradient-to-br from-green-900 to-green-700 text-white py-20">
    <div class="container mx-auto py-10">
        <h1 class="text-center text-6xl font-bold mb-8">{{ __('about.benefit.title') }}</h1>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div class="p-6 rounded-lg">
                <div class="mb-4">
                    <i class="fas fa-check-circle text-4xl"></i>
                </div>
                <h2 class="text-4xl font-semibold py-4">{{ __('about.benefit.reliability_title') }}</h2>
                <p class="mt-2">{{ __('about.benefit.reliability_desc') }}</p>
            </div>
            <div class="p-6 rounded-lg">
                <div class="mb-4">
                    <i class="fas fa-lightbulb text-4xl"></i>
                </div>
                <h2 class="text-4xl font-semibold py-4">{{ __('about.benefit.innovation_title') }}</h2>
                <p class="mt-2">{{ __('about.benefit.innovation_desc') }}</p>
            </div>
            <div class="p-6 rounded-lg">
                <div class="mb-4">
                    <i class="fas fa-user-tie text-4xl"></i>
                </div>
                <h2 class="text-4xl font-semibold py-4">{{ __('about.benefit.professional_title') }}</h2>
                <p class="mt-2">{{ __('about.benefit.professional_desc') }}</p>
            </div>
        </div>
    </div>
</section>
