            ...
            <div class="md:w-1/2 mb-6 md:mb-0 ">
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        ...
                        <div class="mt-6">
                            <a href="{{ url(app()->getLocale() . '/contact') }}" class="btn button-primary hover:scale-105 transition-transform duration-200">
                                {{ __('contact.button') }}
                            </a>
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/10 text-white hover:text-green-500 border-2 border-white hover:border-green-500 ml-4 hover:scale-105 transition-transform duration-200">
            ...
            <div class="grid grid-cols-1 md:{{ $gridClass }} gap-8">
                @foreach ($services as $service)
                    ...
                    <a href="{{ route('service.show', ['lang' => $lang, 'slug' => $service->slug]) }}" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                        <img src="{{ asset('images/' . $service->image) }}" alt="{{ $caption->translated_text ? $caption->translated_text : 'Untitled' }}" class="w-full h-[350px] object-cover group-hover:scale-110 transition-transform duration-500">
        ...
        <div class="container">
            ...
            <div class="flex flex-col md:flex-row gap-20 justify-start pt-10 md:mt-10">
                <div class="w-full md:w-1/2">
                    ...
                    <a href="{{ route('about', ['lang' => app()->getLocale()]) }}" class="btn button-secondary hover:scale-105 transition-transform duration-200">
                        {{ __('about.learn_more') }}
                    </a>
                </div>
                <div class="w-full md:w-1/2">
        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <a href="{{ route('portfolio', ['lang' => app()->getLocale()]) }}" class="btn button-secondary hover:scale-105 transition-transform duration-200">
                ...
                @foreach ($portfolios as $portfolio)
                    <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                        <a href="{{ route('portfolio.show', ['lang' => app()->getLocale(), 'slug' => $portfolio->slug]) }}" class="block">
                            <img src="{{ asset('images/' . $portfolio->image_1) }}" alt="{{ $portfolio->project_name ? $portfolio->project_name->translated_text : 'Untitled' }}" class="w-full h-80 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-75">
