                ...
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        ...
                        <div class="mt-6">
                            ...
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-green-700 text-white/50 hover:text-white border border-white/50 hover:border-green-700 ml-4">
