            ...
            <div class="md:w-1/2 mb-6 md:mb-0 ">
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        <h1 class="lg:text-6xl md:text-4xl text-4xl font-bold leading-tight" data-aos="fade-up" data-aos-delay="200">
                            {{ __('home.headline') }}
                        </h1>
                        <p class="mt-4 tracking-widest" data-aos="fade-up" data-aos-delay="300">{{ __('home.subheadline') }}</p>
                        <div class="mt-6">
                            <a href="{{ url(app()->getLocale() . '/contact') }}" class="btn button-primary hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="400">
                                {{ __('contact.button') }}
                            </a>
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/80 text-white hover:text-green-700 border-2 border-white hover:border-green-700 ml-4 hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="500">
        ...
        <div class="container">
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                <div class="w-full md:w-1/2">
                    <h2 class="uppercase tracking-widest text-green-700" data-aos="fade-up" data-aos-delay="200">{{ __('service.title') }}</h2>
                    <p class="text-6xl mt-4 text-gray-900 font-bold" data-aos="fade-up" data-aos-delay="300">{{ __('service.subtitle') }}</p>
                </div>
                <div class="w-full md:w-1/2">
                    <p class="mb-10 text-gray-700" data-aos="fade-up" data-aos-delay="400">{{ __('service.description') }}</p>
                    <a href="{{ route('services', ['lang' => app()->getLocale()]) }}" class="btn button-secondary inline-flex items-center gap-2 hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="grid grid-cols-1 md:{{ $gridClass }} gap-8">
                @foreach ($services as $index => $service)
                    ...
                    @endphp
                    <a href="{{ route('service.show', ['lang' => $lang, 'slug' => $service->slug]) }}" class="group relative block rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="{{ $delay }}">
    ...
    <section class="py-10 bg-gray-100">
        <div class="container">
            <div class="w-full md:w-3/4">
                <h2 class="uppercase tracking-widest text-green-700" data-aos="fade-up" data-aos-delay="200">{{ __('about.title') }}</h2>
                <p class="text-2xl md:text-4xl mt-4 font-bold" data-aos="fade-up" data-aos-delay="300">{{ __('about.subtitle') }}</p>
            </div>
            <div class="flex flex-col md:flex-row gap-20 justify-start pt-10 md:mt-10">
                <div class="w-full md:w-1/2">
                    <p class="mb-10" data-aos="fade-up" data-aos-delay="400">{{ __('about.description.1') }}</p>
                    <p class="mb-10" data-aos="fade-up" data-aos-delay="500">{{ __('about.description.2') }}</p>
                    <a href="{{ route('about', ['lang' => app()->getLocale()]) }}" class="btn button-secondary hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="600">
                        {{ __('about.learn_more') }}
                    </a>
                </div>
                <div class="w-full md:w-1/2" data-aos="fade-down" data-aos-delay="300">
