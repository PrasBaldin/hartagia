...
<section class="bg-transparent text-white items-center">
    <!-- Background Image -->
    <div class="absolute inset-0 bg-[url('/images/bg-1.jpg')] bg-cover bg-center z-[-2]"></div>
    <!-- Overlay Gradient -->
    <div class="absolute inset-0 bg-gradient-to-br from-gray-900/100 to-transparent z-[-1]"></div>
