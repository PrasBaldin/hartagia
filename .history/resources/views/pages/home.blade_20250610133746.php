...
<section class="bg-gray-900 text-white items-center">
    <!-- Background Image -->
    <div class="absolute inset-0 bg-[url('/images/bg-1.jpg')] bg-cover bg-center z-[-1]"></div>
    <!-- Overlay Gradient -->
    <div class="absolute inset-0 bg-gradient-to-br from-gray-900/80 to-transparent"></div>
