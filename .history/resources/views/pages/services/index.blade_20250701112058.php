                    ...
                    @foreach ($services as $index => $service)
                        ...
                        <div id="service{{ $index }}" class="flex flex-col md:flex-row items-center gap-6 py-10">
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <p class="mt-2" @aos('fade-up', $delay + 200, '#service' . $index)>
                                ...
                                <a href="{{ route('service.show', ['lang' => app()->getLocale(), 'slug' => $service->slug]) }}" class="btn button-secondary mt-6 items-center gap-2 hover:scale-105 transition-transform duration-300" @aos('fade-up', $delay + 600, '#service' . $index)>
                                    <span>
