                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            @foreach ($otherServices as $otherService)
                                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                                    ...
                                    <a href="{{ route('service.show', ['lang' => app()->getLocale(), 'slug' => $otherService->slug]) }}" class="text-green-700 hover:text-green-500 font-bold">{{ __('services.view_details') }}</a>
                                </div>
                            @endforeach
                        </div>
                    </div>
