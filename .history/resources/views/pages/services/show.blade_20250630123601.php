                    ...
                    <div class="w-full md:w-1/3 md:p-8">
                        ...
                        <div class="flex flex-col gap-6">
                            @foreach ($otherServices as $otherService)
                                <a href="{{ route('service.show', ['lang' => app()->getLocale(), 'slug' => $otherService->slug]) }}" class="bg-white p-2 lg:p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
