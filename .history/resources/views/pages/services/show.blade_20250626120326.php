                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="w-full md:w-2/3 bg-white p-8 rounded-lg shadow-lg">
                        ...
                        <div class="text-gray-700">
                            {{ $service->service_content ? $service->service_content->translated_text : 'content' }}
                        </div>
                    </div>
                    <div class="w-full md:w-1/3 p-8">
                        ...
                        <div class="flex flex-col gap-6">
                            @foreach ($otherServices as $otherService)
                                <a href="{{ route('service.show', ['lang' => app()->getLocale(), 'slug' => $otherService->slug]) }}" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                                    <div class="w-full h-48 overflow-hidden rounded mb-4">
                                        <img src="{{ asset('storage/' . $otherService->image) }}" alt="{{ $otherService->service_name ? $otherService->service_name->translated_text : 'title' }}" class="w-full h-48 object-cover hover:scale-105 transition-transform duration-300">
                                    </div>
