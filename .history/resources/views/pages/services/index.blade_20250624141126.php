                    ...
                    @foreach ($services as $service)
                        <div class="flex flex-col md:flex-row items-center gap-6 py-10">
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <a href="{{ route('service.show', ['locale' => app()->getLocale(), 'id' => $service->id]) }}" class="btn button-secondary mt-6 items-center gap-2 hover:scale-105 transition-transform duration-200">
