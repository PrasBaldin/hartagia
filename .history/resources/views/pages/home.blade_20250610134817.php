...
<section class="bg-gray-900/50 text-white items-center">
    ...
    <div class="container flex flex-col md:flex-row">
        ...
        <!-- <div class="relative md:w-1/2 md:pl-[6rem] lg:pl-[10rem] pt-10">
            <div class="flex items-center h-full relative">
                <div class="rounded-lg overflow-hidden w-full md:w-3/4 h-[200px] md:h-[300px] lg:h-[500px] md:absolute top-0 z-[1]">
