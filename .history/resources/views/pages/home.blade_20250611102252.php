...
<section class="py-20 bg-white relative">
    <div class="container mx-auto">
        <h2 class="text-center text-4xl font-bold mb-4">{{ __('gallery.title') }}</h2>
        <p class="text-center text-lg text-gray-500 mb-10">{{ __('gallery.subtitle') ?? 'Explore our recent projects and moments.' }}</p>
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.1') ?? 'Gallery Item 1' }}
                    </span>
                </div>
            </div>
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.2') ?? 'Gallery Item 2' }}
                    </span>
                </div>
            </div>
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.3') ?? 'Gallery Item 3' }}
                    </span>
                </div>
            </div>
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.4') ?? 'Gallery Item 4' }}
                    </span>
                </div>
            </div>
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.5') ?? 'Gallery Item 5' }}
                    </span>
                </div>
            </div>
            <div class="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <span class="text-white text-xl font-semibold tracking-wide">
                        {{ __('gallery.captions.6') ?? 'Gallery Item 6' }}
                    </span>
                </div>
            </div>
        </div>
        <div class="flex justify-center mt-12">
            <a href="{{ url(app()->getLocale() . '/gallery') }}" class="btn button-primary px-8 py-3 text-lg font-semibold">
                {{ __('gallery.view_all') ?? 'View All Photos' }}
            </a>
        </div>
    </div>
    <!-- Decorative shapes -->
    <div class="absolute top-0 left-0 w-32 h-32 bg-green-100 rounded-full opacity-30 -z-10"></div>
    <div class="absolute bottom-0 right-0 w-40 h-40 bg-green-200 rounded-full opacity-20 -z-10"></div>
</section>
