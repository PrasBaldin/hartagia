    ...
    <section class="py-20 bg-gray-100">
        <div class="container">
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center py-10 mb-10">
                ...
                <div class="w-full md:w-1/2">
                    <p class="mb-10 text-gray-700" data-aos="fade-up" data-aos-delay="200">{{ __('service.description') }}</p>
                    <a href="{{ route('services', ['lang' => app()->getLocale()]) }}" class="btn button-secondary inline-flex items-center gap-2 hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="300">
