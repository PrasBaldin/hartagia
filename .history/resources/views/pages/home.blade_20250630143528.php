            ...
            <div class="md:w-1/2 mb-6 md:mb-0 ">
                <div class="flex items-center h-full">
                    <div class="pt-10 pb-20">
                        <h1 class="lg:text-6xl md:text-4xl text-4xl font-bold leading-tight" @aos('fade_up', 200, '#heroSection')>
                            {{ __('home.headline') }}
                        </h1>
                        <p class="mt-4 tracking-widest" @aos('fade_up', 300, '#heroSection')>{{ __('home.subheadline') }}</p>
                        <div class="mt-6">
                            <a href="{{ url(app()->getLocale() . '/contact') }}" class="btn button-primary hover:scale-105 transition-transform duration-300" @aos('fade_up', 400, '#heroSection')>
                                {{ __('contact.button') }}
                            </a>
                            <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="btn button-secondary bg-transparent hover:bg-white/80 text-white hover:text-green-700 border-2 border-white hover:border-green-700 ml-4 hover:scale-105 transition-transform duration-300" @aos('fade_up', 500, '#heroSection')>
