        ...
        <div class="flex">
            <div class="mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 clas s="card-title">Web Development</h5>
                        <p class="card-text">Cu stom web applications and websites tailored to your business needs using the latest techno#
                    </div>
                </div>
                <div class="mb-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">Native and cross-platform mobile solutio ns f
                                or Android and iOS to e ng
                                age your customers on the go.</p>
                        </div>
                    </div>
                </div>
                <div cl ass="mb-4">
                    <div class="card    h-100 s    hadow-sm">
                        <div class="card-body">
