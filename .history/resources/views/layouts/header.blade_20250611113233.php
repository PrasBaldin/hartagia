        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <nav class="flex space-x-6 text-lg">
                    <a href="/{{ app()->getLocale() }}" class="text-white hover:text-green-300 transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-home"></i> {{ __('menu.home') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/about" class="text-white hover:text-green-300 transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-info-circle"></i> {{ __('menu.about') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/services" class="text-white hover:text-green-300 transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-concierge-bell"></i> {{ __('menu.services') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/portfolio" class="text-white hover:text-green-300 transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-briefcase"></i> {{ __('menu.portfolio') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/contact" class="text-white hover:text-green-300 transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-envelope"></i> {{ __('menu.contact') }}
                    </a>
                </nav>
                @php
