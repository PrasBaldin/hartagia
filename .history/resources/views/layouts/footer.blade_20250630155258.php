            ...
            <div id="footerAbout">
                ...
                <div class="flex gap-4 mt-4">
                    <div class="inline-block" @aos('fade-up', 400, '#footerAbout')>
                        <a href="{{ $contact->facebook_url ? $contact->facebook_url : '#' }}" class="text-blue-500 hover:text-blue-700 hover:scale-105 transition-transform duration-300">
                            <i class="fab fa-facebook fa-lg"></i>
                        </a>
                    </div>
                    <div class="inline-block" @aos('fade-up', 500, '#footerAbout')>
                        <a href="{{ $contact->instagram_url ? $contact->instagram_url : '#' }}" class="text-pink-500 hover:text-pink-700 hover:scale-105 transition-transform duration-300">
                            <i class="fab fa-instagram fa-lg"></i>
                        </a>
                    </div>
                    <div class="inline-block" @aos('fade-up', 600, '#footerAbout')>
                        <a href="{{ $contact->tiktok_url ? $contact->tiktok_urls : '#' }}" class="text-black hover:text-gray-800 hover:scale-105 transition-transform duration-300">
