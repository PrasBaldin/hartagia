<section class="parallax-container relative bg-gray-900 text-white py-20 px-6 text-center">
    {{-- Background overlay --}}
    <div class="parallax-bg absolute inset-0 bg-black bg-opacity-60"></div>
