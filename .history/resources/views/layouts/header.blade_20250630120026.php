        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    ...
                    <a href="https://katalog.inaproc.id/harta-gemilang-aselindo" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale . '/services') || request()->is($getLocale . '/services/*') ? 'font-bold text-green-500' : 'text-white' }}">
                        {{ __('menu.services') }}
                    </a>
