        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <a href="/{{ app()->getLocale() }}" class="flex items-center">
                    ...
                    <span class="hidden xs:!block text-white font-bold ml-2">PT. HARTA GEMILANG ASELINDO</span>
                </a>
            </div>
            <!-- Mobile Hamburger -->
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    <a href="/{{ app()->getLocale() }}" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale()) ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.home') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/about" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/about') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.about') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/services" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/services') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.services') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/portfolio" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/portfolio') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.portfolio') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/contact" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/contact') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.contact') }}
                    </a>
                </nav>
                @php
                $locale = request()->segment(1); // Ambil prefix bahasa dari URL (id/en)
                $path = request()->path(); // Dapatkan seluruh path tanpa perubahan
