        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    <a href="/{{ app()->getLocale() }}" class="text-white hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale()) ? 'font-bold text-green-700' : 'text-gray-700' }}">
                        {{ __('menu.home') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/about" class="text-white hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/about') ? 'font-bold text-green-700' : 'text-gray-700' }}">
                        {{ __('menu.about') }}
                    </a>
    ...
    <aside id="mobile-sidebar" class="fixed inset-0 bg-gray-900 flex flex-col items-center justify-center z-50 transform translate-x-full transition-transform duration-300 lg:hidden">
        ...
        <div class="w-full p-20 pt-0">
            ...
            <nav class="flex flex-col space-y-8 text-4xl w-full justify-start">
                <a href="/{{ app()->getLocale() }}" class="text-white hover:text-green-300 transition-all duration-300 {{ request()->is(app()->getLocale()) ? 'font-bold text-green-700' : 'text-gray-700' }}" onclick="closeMobileMenu()">
                    {{ __('menu.home') }}
                </a>
                <a href="/{{ app()->getLocale() }}/about" class="text-white hover:text-green-300 transition-all duration-300 {{ request()->is(app()->getLocale().'/about') ? 'font-bold text-green-700' : 'text-gray-700' }}" onclick="closeMobileMenu()">
                    {{ __('menu.about') }}
                </a>
                <a href="/{{ app()->getLocale() }}/services" class="text-white hover:text-green-300 transition-all duration-300 {{ request()->is(app()->getLocale().'/services') ? 'font-bold text-green-700' : 'text-gray-700' }}" onclick="closeMobileMenu()">
                    {{ __('menu.services') }}
                </a>
                <a href="/{{ app()->getLocale() }}/portfolio" class="text-white hover:text-green-300 transition-all duration-300 {{ request()->is(app()->getLocale().'/portfolio') ? 'font-bold text-green-700' : 'text-gray-700' }}" onclick="closeMobileMenu()">
                    {{ __('menu.portfolio') }}
                </a>
                <a href="/{{ app()->getLocale() }}/contact" class="text-white hover:text-green-300 transition-all duration-300 {{ request()->is(app()->getLocale().'/contact') ? 'font-bold text-green-700' : 'text-gray-700' }}" onclick="closeMobileMenu()">
                    {{ __('menu.contact') }}
                </a>
            </nav>
