        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    ...
                    <a href="/{{ app()->getLocale() }}/portfolio" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is([app()->getLocale() . '/portfolio', app()->getLocale() . '/portfolio/*']) ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.portfolio') }}
                    </a>
