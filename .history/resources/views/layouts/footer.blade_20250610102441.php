        ...
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-2">
                <div class="flex justify-between">
                    <span class="font-bold">{{ __('footer.email') }}:</span>
                    <span>hartagia@gmail.com</span>
                </div>
                <div class="flex justify-between">
                    <span class="font-bold">{{ __('footer.phone') }}:</span>
                    <span>021 22802410</span>
                </div>
                <div class="flex justify-between">
                    <span class="font-bold">{{ __('footer.address') }}:</span>
                    <span class="text-right">
                        Jl. SMA 14 No. 47 B<br>
                        RT.002/RW.004 Cililitan,<br>
            ...
            <div>
                ...
                <p>{{ __('footer.email') }}: hartagia@gmail.com</p>
                <p>{{ __('footer.phone') }}: 021 22802410</p>
                <p class="mt-2">{{ __('footer.address') }}</p>
            </div>
        </div>
    </div>
