        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <nav class="flex space-x-6 text-lg">
                    <a href="/{{ app()->getLocale() }}" class="text-white hover:text-green-300 hover:scale-[1.2] transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.home') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/about" class="text-white hover:text-green-300 hover:scale-[1.2] transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.about') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/services" class="text-white hover:text-green-300 hover:scale-[1.2] transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.services') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/portfolio" class="text-white hover:text-green-300 hover:scale-[1.2] transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.portfolio') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/contact" class="text-white hover:text-green-300 hover:scale-[1.2] transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.contact') }}
                    </a>
                </nav>
                @php
