        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    @php
                        $locale = app()->getLocale(); // Ambil locale saat ini
                    @endphp
                    ...
                    <a href="/{{ app()->getLocale() }}/portfolio" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale() . '/portfolio') || request()->is(app()->getLocale() . '/portfolio/*') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.portfolio') }}
                    </a>
