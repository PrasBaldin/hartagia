<section class="parallax-container bg-gradient-to-br from-gray-900/100 to-black/30">
    ...
    <div class="container">
        <div class="relative z-10 max-w-3xl mx-auto">
            <h2 class="text-2xl md:text-4xl font-bold mb-4">{{ __('join_us.title') }}</h2>
            <p class="mb-6">
                {{ __('join_us.subtitle') }}
            </p>
        ...
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <div class="flex gap-4 mt-4">
                    <a href="{{ $contact->facebook_url ? $contact->facebook_url : '#' }}" class="text-blue-500 hover:text-blue-700"><i class="fab fa-facebook fa-lg"></i></a>
                    <a href="{{ $contact->instagram_url ? $contact->instagram_urlss : '#' }}" class="text-pink-500 hover:text-pink-700"><i class="fab fa-instagram fa-lg"></i></a>
                    <a href="{{ $contact->tiktok_url ? $contact->tiktok_urls : '#' }}" class="text-black hover:text-gray-800"><i class="fab fa-tiktok fa-lg"></i></a>
                </div>
            </div>
            {{-- Tautan Cepat --}}
            <div>
            ...
            <div>
                ...
                <table class="w-full border-collapse">
                    <tr>
                        ...
                        <td class="pr-2">:</td>
                        <td>{{ $contact->contact_email ? $contact->contact_email : '-' }}</td>
                    </tr>
                    <tr>
                        <td class="pr-2"><i class="fas fa-phone-alt text-gray-700"></i></td>
                        <td class="pr-2">:</td>
                        <td>{{ $contact->contact_phone ? $contact->contact_phone : '-' }}</td>
                    </tr>
                    <tr>
