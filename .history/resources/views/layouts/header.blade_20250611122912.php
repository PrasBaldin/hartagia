        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    <a href="/{{ app()->getLocale() }}" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale()) ? 'font-bold text-green-700' : 'text-gray-700' }}">
                        {{ __('menu.home') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/about" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is(app()->getLocale().'/about') ? 'font-bold text-green-700' : 'text-gray-700' }}">
                        {{ __('menu.about') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/services" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.services') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/portfolio" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.portfolio') }}
                    </a>
                    <a href="/{{ app()->getLocale() }}/contact" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2">
                        {{ __('menu.contact') }}
                    </a>
                </nav>
                @php
