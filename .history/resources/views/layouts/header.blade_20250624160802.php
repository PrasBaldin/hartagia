        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:!flex items-center space-x-6">
                <nav class="flex space-x-6">
                    ...
                    @endphp
                    <a href="/{{ app()->getLocale() }}" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale) ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.home') }}
                    </a>
                    <a href="/{{ $getLocale }}/about" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale . '/about') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.about') }}
                    </a>
                    <a href="/{{ $getLocale }}/services" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale . '/services') || request()->is($getLocale . '/services/*') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.services') }}
                    </a>
                    <a href="/{{ $getLocale }}/portfolio" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale . '/portfolio') || request()->is($getLocale . '/portfolio/*') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.portfolio') }}
                    </a>
                    <a href="/{{ $getLocale }}/contact" class="hover:text-green-300 hover:scale-110 transition-all duration-300 flex items-center gap-2 {{ request()->is($getLocale . '/contact') ? 'font-bold text-green-700' : 'text-white' }}">
                        {{ __('menu.contact') }}
                    </a>
                </nav>
                @php
