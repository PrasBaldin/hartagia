<section class="parallax-container">
    ...
    <script>
        document.addEventListener('scroll', function() {
            ...
            let scaleValue = 1.5 - (scrollPos * 0.0000000005); // Semakin scroll ke bawah, semakin mengecil

            document.querySelector('.parallax-bg').style.transform = `translateY(${scrollPos * -0.2}px) scale(${scaleValue})`;
        });
    </script>
