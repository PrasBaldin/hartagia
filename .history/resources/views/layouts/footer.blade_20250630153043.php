    ...
    <div class="container mx-auto">
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div id="footerAbout">
                ...
                <p class="mb-4" @aos('fade-down', 300, '#footerAbout')>
                    {{ __('footer.about_desc') }}
                </p>
                <div class="flex gap-4 mt-4">
                    <a href="{{ $contact->facebook_url ? $contact->facebook_url : '#' }}" class="text-blue-500 hover:text-blue-700" @aos('fade-down', 200, '#footerAbout')>
                        <i class="fab fa-facebook fa-lg"></i>
                    </a>
                    <a href="{{ $contact->instagram_url ? $contact->instagram_url : '#' }}" class="text-pink-500 hover:text-pink-700" @aos('fade-down', 300, '#footerAbout')>
                        <i class="fab fa-instagram fa-lg"></i>
                    </a>
                    <a href="{{ $contact->tiktok_url ? $contact->tiktok_urls : '#' }}" class="text-black hover:text-gray-800" @aos('fade-down', 400, '#footerAbout')>
