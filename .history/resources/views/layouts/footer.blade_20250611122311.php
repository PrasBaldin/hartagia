    ...
    <div class="container mx-auto">
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-1">
                    <li><a href="/{{ app()->getLocale() }}" class="text-green-700 hover:scale-105 transition-all duration-300 {{ request()->is(app()->getLocale()) ? 'font-bold text-green-700' : 'text-gray-700' }}">{{ __('menu.home') }}</a></li>
                    <li><a href="/{{ app()->getLocale() }}/about" class="text-green-700 hover:scale-105 transition-all duration-300 {{ request()->is(app()->getLocale(/about)) ? 'font-bold text-green-700' : 'text-gray-700' }}">{{ __('menu.about') }}</a></li>
                    <li><a href="/{{ app()->getLocale() }}/services" class="text-green-700 hover:scale-105 transition-all duration-300 {{ request()->is(app()->getLocale(/services)) ? 'font-bold text-green-700' : 'text-gray-700' }}">{{ __('menu.services') }}</a></li>
                    <li><a href="/{{ app()->getLocale() }}/portfolio" class="text-green-700 hover:scale-105 transition-all duration-300 {{ request()->is(app()->getLocale(/portfolio)) ? 'font-bold text-green-700' : 'text-gray-700' }}">{{ __('menu.portfolio') }}</a></li>
                    <li><a href="/{{ app()->getLocale() }}/contact" class="text-green-700 hover:scale-105 transition-all duration-300 {{ request()->is(app()->getLocale(/contact)) ? 'font-bold text-green-700' : 'text-gray-700' }}">{{ __('menu.contact') }}</a></li>
                </ul>
            </div>
