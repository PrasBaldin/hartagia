    ...
    <div class="container mx-auto">
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <table class="w-full border-collapse">
                <tr>
                    <td class="font-bold pr-4">{{ __('footer.email_subtitle') }}</td>
                    <td>:</td>
                    <td>hartagia@gmail.com</td>
                </tr>
                <tr>
                    <td class="font-bold pr-4">{{ __('footer.phone_subtitle') }}</td>
                    <td>:</td>
                    <td>021 22802410</td>
                </tr>
                <tr>
                    <td class="font-bold pr-4 align-top">{{ __('footer.address_subtitle') }}</td>
