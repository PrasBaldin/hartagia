        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex space-x-2">
                    @if ($locale === 'id')
                    <a href="/en"><img src="/icons/id.svg" class="w-8 rounded-full"></a>
                    @else
                    <a href="/id"><img src="/icons/en.svg" class="w-8 rounded-full"></a>
                    @endif
                </div>

                <!-- <div class="flex space-x-2">
                    <a href="/id"><img src="/icons/id.svg" class="w-8 rounded-full"></a>
                    <a href="/en"><img src="/icons/en.svg" class="w-8 rounded-full"></a>
                </div> -->
            </div>
        </div>
    </div>
