    ...
    <section>
        <div class="container">
            <div class="flex items-center justify-between flex-col md:flex-row gap-10 py-20">
                ...
                <div class="md:w-1/2">
                    <div class="mb-6">
                        <h2 class="uppercase tracking-widest text-green-700 mb-2" @aos('fade-down', 200)>
                            {{ __('contact.title') }}
                        </h2>
                    ...
                    <div id="contactInfo" class="space-y-6">
                        <div class="flex items-center space-x-4" @aos('fade-up', 400, '#contactInfo')>
                        ...
                        <div class="flex items-center space-x-4" @aos('fade-up', 500, '#contactInfo')>
                            <span class="inline-flex items-center justify-center w-10 h-10 bg-green-700 text-white rounded-full">
                        ...
                        <div class="flex items-center space-x-4" @aos('fade-up', 600, '#contactInfo')>
                        ...
                        <div class="flex items-center space-x-4" @aos('fade-up', 700, '#contactInfo')>
                            <span class="inline-flex items-center justify-center w-10 h-10 bg-green-700 text-white rounded-full mt-1 flex-shrink-0">
                    ...
                    <div class="mt-10" @aos('fade-up', 700)>
