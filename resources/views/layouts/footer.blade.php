        ...
        <div class="px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div id="footerContact">
                ...
                <table class="w-full border-collapse">
                    ...
                    <tr>
                        <td class="pr-2" @aos('fade-up', 800, '#footerContact')>
                            <i class="fab fa-whatsapp text-gray-700"></i>
                        </td>
                        <td class="pr-2" @aos('fade-up', 900, '#footerContact')>
                            :
                        </td>
                        <td @aos('fade-up', 1000, '#footerContact')>
                            {{ $contact->contact_wa ? $contact->contact_wa : '-' }}
                        </td>
                    </tr>
                    <tr>
                        <td class="pr-2 align-top" @aos('fade-up', 1100, '#footerContact')>
                            <i class="fas fa-map-marker-alt text-gray-700"></i>
                        </td>
                        <td class="pr-2 align-top" @aos('fade-up', 1200, '#footerContact')>
                            :
                        </td>
                        <td @aos('fade-up', 1300, '#footerContact')>
